...
const MetadatoAvroCRC64Fingerprint = "\"}\x88^\xec\xb4\xe6\xf5"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"default\":null,\"name\":\"contenido\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.PublicadorMobileElecciones.Events.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.PublicadorMobileElecciones.Events.Common.Metadato"
}
