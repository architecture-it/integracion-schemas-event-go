...
const SerieAvroCRC64Fingerprint = "\x7f,Հ\xbf\x83\x91\xbf"
...
func (r Serie) Schema() string {
	return "{\"fields\":[{\"name\":\"Serie\",\"type\":\"string\"}],\"name\":\"Andreani.WosTraza.Events.AgrupadorasCommon.Serie\",\"type\":\"record\"}"
}

func (r Serie) SchemaName() string {
	return "Andreani.WosTraza.Events.AgrupadorasCommon.Serie"
}
