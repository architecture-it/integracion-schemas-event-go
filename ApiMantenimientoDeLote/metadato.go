...
const MetadatoAvroCRC64Fingerprint = "\xddc'\xd6o\xea\xb5#"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.ApiMantenimientoDeLote.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.ApiMantenimientoDeLote.Events.Record.Metadato"
}
