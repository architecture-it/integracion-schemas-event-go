...
type DetallePreenvio struct {
	...
	Retornable *UnionNullBool `json:"Retornable"`

	NroFactura *UnionNullString `json:"NroFactura"`
...
const DetallePreenvioAvroCRC64Fingerprint = "d'\x05\xb2\xbcοu"
...
func writeDetallePreenvio(r DetallePreenvio, w io.Writer) error {
	...
	err = writeUnionNullBool(r.Retornable, w)
	if err != nil {
		return err
	}
	err = writeUnionNullString(r.NroFactura, w)
	if err != nil {
		return err
	}
...
func (r *DetallePreenvio) Get(i int) types.Field {
	...
	case 7:
		r.Retornable = NewUnionNullBool()

		return r.Retornable
	case 8:
		r.NroFactura = NewUnionNullString()
...
func (r DetallePreenvio) MarshalJSON() ([]byte, error) {
	...
	output["NroFactura"], err = json.Marshal(r.NroFactura)
	if err != nil {
		return nil, err
	}
...
func (r *DetallePreenvio) UnmarshalJSON(data []byte) error {
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.NroFactura); err != nil {
			return err
		}
	} else {
		r.NroFactura = NewUnionNullString()
