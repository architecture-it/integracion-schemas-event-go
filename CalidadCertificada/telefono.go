...
const TelefonoAvroCRC64Fingerprint = "\xa57E\rB\x9e\xa3\v"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"name\":\"Tipo\",\"type\":\"int\"},{\"name\":\"Numero\",\"type\":\"string\"}],\"name\":\"Andreani.CalidadCertificada.Events.Record.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Andreani.CalidadCertificada.Events.Record.Telefono"
}
