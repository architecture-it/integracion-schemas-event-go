...
const SeriesAvroCRC64Fingerprint = "\xae\xb6SG\x8btR\x06"
...
func (r Series) Schema() string {
	return "{\"fields\":[{\"name\":\"Serie\",\"type\":\"string\"}],\"name\":\"Andreani.SppeApi.Events.Common.Series\",\"type\":\"record\"}"
}

func (r Series) SchemaName() string {
	return "Andreani.SppeApi.Events.Common.Series"
}
