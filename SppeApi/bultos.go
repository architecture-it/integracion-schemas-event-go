...
const BultosAvroCRC64Fingerprint = "P\xf45\x90\xfb\xe6\xcf\xe9"
...
func (r Bultos) Schema() string {
	return "{\"fields\":[{\"name\":\"DropId\",\"type\":\"string\"},{\"name\":\"Altura\",\"type\":\"float\"},{\"name\":\"Profundidad\",\"type\":\"float\"},{\"name\":\"Ancho\",\"type\":\"float\"},{\"name\":\"Peso\",\"type\":\"float\"}],\"name\":\"Andreani.SppeApi.Events.Common.Bultos\",\"type\":\"record\"}"
}

func (r Bultos) SchemaName() string {
	return "Andreani.SppeApi.Events.Common.Bultos"
}
