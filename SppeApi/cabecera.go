...
const CabeceraAvroCRC64Fingerprint = "\x8cK\x92w\xf6V\x99\xc9"
...
func (r Cabecera) Schema() string {
	return "{\"fields\":[{\"name\":\"OrdenWh\",\"type\":\"string\"},{\"name\":\"OrdenCliente\",\"type\":\"string\"},{\"name\":\"NumeroEnvio\",\"type\":\"string\"},{\"name\":\"ContratoTMS\",\"type\":\"string\"}],\"name\":\"Andreani.SppeApi.Events.OrdenDeEnvioGeneradaCommon.Cabecera\",\"type\":\"record\"}"
}

func (r Cabecera) SchemaName() string {
	return "Andreani.SppeApi.Events.OrdenDeEnvioGeneradaCommon.Cabecera"
}
