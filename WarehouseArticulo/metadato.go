...
const MetadatoAvroCRC64Fingerprint = "\xbe\xff˃\x96\x83@\xe0"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.WarehouseArticulo.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.WarehouseArticulo.Events.Record.Metadato"
}
