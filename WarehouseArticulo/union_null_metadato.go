...
func (r *UnionNullMetadato) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullMetadatoTypeEnumMetadato:
		return json.Marshal(map[string]interface{}{"Andreani.WarehouseArticulo.Events.Record.Metadato": r.Metadato})
	}
...
func (r *UnionNullMetadato) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.WarehouseArticulo.Events.Record.Metadato"]; ok {
		r.UnionType = 1
