...
func (r *UnionNullDestinatario) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"codigoPostal\",\"type\":\"string\"},{\"name\":\"direccion\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"},{\"default\":null,\"name\":\"piso\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"departamento\",\"type\":[\"null\",\"string\"]},{\"name\":\"localidad\",\"type\":\"string\"}],\"name\":\"Destinatario\",\"namespace\":\"Andreani.AccionesUnificada.Events.Common\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDestinatario) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDestinatarioTypeEnumDestinatario:
		return json.Marshal(map[string]interface{}{"Andreani.AccionesUnificada.Events.Common.Destinatario": r.Destinatario})
	}
...
func (r *UnionNullDestinatario) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.AccionesUnificada.Events.Common.Destinatario"]; ok {
		r.UnionType = 1
