...
const MetadatoAvroCRC64Fingerprint = "$\x1c\x9c\x1d\xe3\xf7\x89S"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.AccionesUnificada.Events.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.AccionesUnificada.Events.Common.Metadato"
}
