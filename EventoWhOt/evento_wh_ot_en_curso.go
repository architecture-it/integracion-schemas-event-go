...
const EventoWhOtEnCursoAvroCRC64Fingerprint = "\xf3\xed%w\xb8F\xc3\x15"

func NewEventoWhOtEnCurso() EventoWhOtEnCurso {
	r := EventoWhOtEnCurso{}
...
func DeserializeEventoWhOtEnCurso(r io.Reader) (EventoWhOtEnCurso, error) {
	t := NewEventoWhOtEnCurso()
...
func DeserializeEventoWhOtEnCursoFromSchema(r io.Reader, schema string) (EventoWhOtEnCurso, error) {
	t := NewEventoWhOtEnCurso()
...
func writeEventoWhOtEnCurso(r EventoWhOtEnCurso, w io.Writer) error {
	var err error
...
func (r *EventoWhOtEnCurso) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtEnCurso) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtEnCurso) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtEnCurso) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtEnCurso) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtEnCurso) Finalize()                        {}

func (_ EventoWhOtEnCurso) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtEnCursoAvroCRC64Fingerprint)
}

func (r EventoWhOtEnCurso) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtEnCurso) UnmarshalJSON(data []byte) error {
