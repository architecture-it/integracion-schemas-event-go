...
const SeriesAvroCRC64Fingerprint = "jg\xb6:\xf3\x9an\xf3"
...
func (r Series) Schema() string {
	return "{\"fields\":[{\"name\":\"Serie\",\"type\":\"string\"}],\"name\":\"Andreani.EventoWhOt.Events.OtPedidoConErrorCommon.Series\",\"type\":\"record\"}"
}

func (r Series) SchemaName() string {
	return "Andreani.EventoWhOt.Events.OtPedidoConErrorCommon.Series"
}
