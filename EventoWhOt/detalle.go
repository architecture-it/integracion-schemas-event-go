...
type Detalle struct {
	...
	DescripcionEstadoOtAcondi *UnionNullString `json:"DescripcionEstadoOtAcondi"`
}

const DetalleAvroCRC64Fingerprint = "\x97ad\xe0\x16\\!\xe5"
...
func writeDetalle(r Detalle, w io.Writer) error {
	...
	err = writeUnionNullString(r.DescripcionEstadoOtAcondi, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Detalle) Get(i int) types.Field {
	...
	case 34:
		r.DescripcionEstadoOtAcondi = NewUnionNullString()

		return r.DescripcionEstadoOtAcondi
	}
...
func (r *Detalle) NullField(i int) {
	...
	case 33:
		...
		return
	case 34:
		r.DescripcionEstadoOtAcondi = nil
		return
	}
...
func (r Detalle) MarshalJSON() ([]byte, error) {
	...
	output["DescripcionEstadoOtAcondi"], err = json.Marshal(r.DescripcionEstadoOtAcondi)
	if err != nil {
		return nil, err
	}
...
func (r *Detalle) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["DescripcionEstadoOtAcondi"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.DescripcionEstadoOtAcondi); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for DescripcionEstadoOtAcondi")
	}
	return nil
}
