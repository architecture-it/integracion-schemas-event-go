...
type EventoWhOtConError struct {
...
const EventoWhOtConErrorAvroCRC64Fingerprint = "\xab@\xbdִ\x0e\x94v"

func NewEventoWhOtConError() EventoWhOtConError {
	r := EventoWhOtConError{}
...
func DeserializeEventoWhOtConError(r io.Reader) (EventoWhOtConError, error) {
	t := NewEventoWhOtConError()
...
func DeserializeEventoWhOtConErrorFromSchema(r io.Reader, schema string) (EventoWhOtConError, error) {
	t := NewEventoWhOtConError()
...
func writeEventoWhOtConError(r EventoWhOtConError, w io.Writer) error {
	var err error
...
func (r *EventoWhOtConError) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtConError) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtConError) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtConError) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtConError) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtConError) Finalize()                        {}

func (_ EventoWhOtConError) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtConErrorAvroCRC64Fingerprint)
}

func (r EventoWhOtConError) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtConError) UnmarshalJSON(data []byte) error {
