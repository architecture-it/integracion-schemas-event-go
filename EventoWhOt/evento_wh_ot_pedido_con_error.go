...
type EventoWhOtPedidoConError struct {
...
const EventoWhOtPedidoConErrorAvroCRC64Fingerprint = "\x06\xe7vG\xc3?\xacx"

func NewEventoWhOtPedidoConError() EventoWhOtPedidoConError {
	r := EventoWhOtPedidoConError{}
...
func DeserializeEventoWhOtPedidoConError(r io.Reader) (EventoWhOtPedidoConError, error) {
	t := NewEventoWhOtPedidoConError()
...
func DeserializeEventoWhOtPedidoConErrorFromSchema(r io.Reader, schema string) (EventoWhOtPedidoConError, error) {
	t := NewEventoWhOtPedidoConError()
...
func writeEventoWhOtPedidoConError(r EventoWhOtPedidoConError, w io.Writer) error {
	var err error
...
func (r *EventoWhOtPedidoConError) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtPedidoConError) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtPedidoConError) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtPedidoConError) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtPedidoConError) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtPedidoConError) Finalize()                        {}

func (_ EventoWhOtPedidoConError) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtPedidoConErrorAvroCRC64Fingerprint)
}

func (r EventoWhOtPedidoConError) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtPedidoConError) UnmarshalJSON(data []byte) error {
