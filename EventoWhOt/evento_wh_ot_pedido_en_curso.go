...
type EventoWhOtPedidoEnCurso struct {
...
const EventoWhOtPedidoEnCursoAvroCRC64Fingerprint = "\x12.\x80\x9a\x92\xf2\xde~"

func NewEventoWhOtPedidoEnCurso() EventoWhOtPedidoEnCurso {
	r := EventoWhOtPedidoEnCurso{}
...
func DeserializeEventoWhOtPedidoEnCurso(r io.Reader) (EventoWhOtPedidoEnCurso, error) {
	t := NewEventoWhOtPedidoEnCurso()
...
func DeserializeEventoWhOtPedidoEnCursoFromSchema(r io.Reader, schema string) (EventoWhOtPedidoEnCurso, error) {
	t := NewEventoWhOtPedidoEnCurso()
...
func writeEventoWhOtPedidoEnCurso(r EventoWhOtPedidoEnCurso, w io.Writer) error {
	var err error
...
func (r *EventoWhOtPedidoEnCurso) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtPedidoEnCurso) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtPedidoEnCurso) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtPedidoEnCurso) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtPedidoEnCurso) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtPedidoEnCurso) Finalize()                        {}

func (_ EventoWhOtPedidoEnCurso) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtPedidoEnCursoAvroCRC64Fingerprint)
}

func (r EventoWhOtPedidoEnCurso) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtPedidoEnCurso) UnmarshalJSON(data []byte) error {
