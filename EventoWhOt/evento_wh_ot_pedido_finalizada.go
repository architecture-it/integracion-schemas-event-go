...
/*
 * SOURCE:
 *     EventoWhOtPedidoFinalizada.avsc
 */
...
type EventoWhOtPedidoFinalizada struct {
...
const EventoWhOtPedidoFinalizadaAvroCRC64Fingerprint = "Em\xd22\xb2\x98\xffg"

func NewEventoWhOtPedidoFinalizada() EventoWhOtPedidoFinalizada {
	r := EventoWhOtPedidoFinalizada{}
...
func DeserializeEventoWhOtPedidoFinalizada(r io.Reader) (EventoWhOtPedidoFinalizada, error) {
	t := NewEventoWhOtPedidoFinalizada()
...
func DeserializeEventoWhOtPedidoFinalizadaFromSchema(r io.Reader, schema string) (EventoWhOtPedidoFinalizada, error) {
	t := NewEventoWhOtPedidoFinalizada()
...
func writeEventoWhOtPedidoFinalizada(r EventoWhOtPedidoFinalizada, w io.Writer) error {
	var err error
...
func (r *EventoWhOtPedidoFinalizada) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtPedidoFinalizada) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtPedidoFinalizada) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtPedidoFinalizada) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtPedidoFinalizada) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtPedidoFinalizada) Finalize()                        {}

func (_ EventoWhOtPedidoFinalizada) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtPedidoFinalizadaAvroCRC64Fingerprint)
}

func (r EventoWhOtPedidoFinalizada) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtPedidoFinalizada) UnmarshalJSON(data []byte) error {
