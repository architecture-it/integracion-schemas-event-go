...
/*
 * SOURCE:
 *     EventoWhOtRecepcionEnCurso.avsc
 */
...
type EventoWhOtRecepcionEnCurso struct {
...
const EventoWhOtRecepcionEnCursoAvroCRC64Fingerprint = "\x0e\xcb\xca=\x88\xedrL"

func NewEventoWhOtRecepcionEnCurso() EventoWhOtRecepcionEnCurso {
	r := EventoWhOtRecepcionEnCurso{}
...
func DeserializeEventoWhOtRecepcionEnCurso(r io.Reader) (EventoWhOtRecepcionEnCurso, error) {
	t := NewEventoWhOtRecepcionEnCurso()
...
func DeserializeEventoWhOtRecepcionEnCursoFromSchema(r io.Reader, schema string) (EventoWhOtRecepcionEnCurso, error) {
	t := NewEventoWhOtRecepcionEnCurso()
...
func writeEventoWhOtRecepcionEnCurso(r EventoWhOtRecepcionEnCurso, w io.Writer) error {
	var err error
...
func (r *EventoWhOtRecepcionEnCurso) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtRecepcionEnCurso) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtRecepcionEnCurso) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionEnCurso) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionEnCurso) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionEnCurso) Finalize()                        {}

func (_ EventoWhOtRecepcionEnCurso) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtRecepcionEnCursoAvroCRC64Fingerprint)
}

func (r EventoWhOtRecepcionEnCurso) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtRecepcionEnCurso) UnmarshalJSON(data []byte) error {
