...
/*
 * SOURCE:
 *     EventoWhOtRecepcionConError.avsc
 */
...
type EventoWhOtRecepcionConError struct {
...
const EventoWhOtRecepcionConErrorAvroCRC64Fingerprint = "\xe9<x\n\x92lÉ"

func NewEventoWhOtRecepcionConError() EventoWhOtRecepcionConError {
	r := EventoWhOtRecepcionConError{}
...
func DeserializeEventoWhOtRecepcionConError(r io.Reader) (EventoWhOtRecepcionConError, error) {
	t := NewEventoWhOtRecepcionConError()
...
func DeserializeEventoWhOtRecepcionConErrorFromSchema(r io.Reader, schema string) (EventoWhOtRecepcionConError, error) {
	t := NewEventoWhOtRecepcionConError()
...
func writeEventoWhOtRecepcionConError(r EventoWhOtRecepcionConError, w io.Writer) error {
	var err error
...
func (r *EventoWhOtRecepcionConError) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtRecepcionConError) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtRecepcionConError) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhOtRecepcionConError) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionConError) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionConError) Finalize()                {}

func (_ EventoWhOtRecepcionConError) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtRecepcionConErrorAvroCRC64Fingerprint)
}

func (r EventoWhOtRecepcionConError) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtRecepcionConError) UnmarshalJSON(data []byte) error {
