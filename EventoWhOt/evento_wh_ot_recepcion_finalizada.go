...
type EventoWhOtRecepcionFinalizada struct {
...
const EventoWhOtRecepcionFinalizadaAvroCRC64Fingerprint = "\xa0\xb5\xee\xeb3y\x9b\x96"

func NewEventoWhOtRecepcionFinalizada() EventoWhOtRecepcionFinalizada {
	r := EventoWhOtRecepcionFinalizada{}
...
func DeserializeEventoWhOtRecepcionFinalizada(r io.Reader) (EventoWhOtRecepcionFinalizada, error) {
	t := NewEventoWhOtRecepcionFinalizada()
...
func DeserializeEventoWhOtRecepcionFinalizadaFromSchema(r io.Reader, schema string) (EventoWhOtRecepcionFinalizada, error) {
	t := NewEventoWhOtRecepcionFinalizada()
...
func writeEventoWhOtRecepcionFinalizada(r EventoWhOtRecepcionFinalizada, w io.Writer) error {
	var err error
...
func (r *EventoWhOtRecepcionFinalizada) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhOtRecepcionFinalizada) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhOtRecepcionFinalizada) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhOtRecepcionFinalizada) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionFinalizada) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhOtRecepcionFinalizada) Finalize()                {}

func (_ EventoWhOtRecepcionFinalizada) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhOtRecepcionFinalizadaAvroCRC64Fingerprint)
}

func (r EventoWhOtRecepcionFinalizada) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhOtRecepcionFinalizada) UnmarshalJSON(data []byte) error {
