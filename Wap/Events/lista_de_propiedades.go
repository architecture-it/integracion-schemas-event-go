...
const ListaDePropiedadesAvroCRC64Fingerprint = "\\\x82?\x8c{\x12\xc3m"
...
func (r ListaDePropiedades) Schema() string {
	return "{\"fields\":[{\"name\":\"metadatos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Metadato\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Andreani.Wap.DatosDeReferencia.ListaDePropiedades\",\"type\":\"record\"}"
}

func (r ListaDePropiedades) SchemaName() string {
	return "Andreani.Wap.DatosDeReferencia.ListaDePropiedades"
}
