...
func (r *UnionNullListaDeTelefonos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeTelefonosTypeEnumListaDeTelefonos:
		return json.Marshal(map[string]interface{}{"Andreani.Wap.DatosDeReferencia.ListaDeTelefonos": r.ListaDeTelefonos})
	}
...
func (r *UnionNullListaDeTelefonos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.Wap.DatosDeReferencia.ListaDeTelefonos"]; ok {
		r.UnionType = 1
