...
type DetalleDeOrdenDeCompra struct {
	...
	Articulo *UnionNullArticulo `json:"articulo"`
...
const DetalleDeOrdenDeCompraAvroCRC64Fingerprint = "\xc4z\v\x80v\x0e\xa7\xa1"
...
func writeDetalleDeOrdenDeCompra(r DetalleDeOrdenDeCompra, w io.Writer) error {
	...
	err = writeUnionNullArticulo(r.Articulo, w)
	if err != nil {
		return err
	}
...
func (r *DetalleDeOrdenDeCompra) Get(i int) types.Field {
	...
	case 6:
		...
		return r.UOM
	case 7:
		r.Articulo = NewUnionNullArticulo()
