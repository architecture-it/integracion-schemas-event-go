...
const TelefonoAvroCRC64Fingerprint = "\xa8\xa8\xc2b\xc4\r\x84\x1b"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"name\":\"tipo\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Andreani.Wap.DatosDeReferencia.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Andreani.Wap.DatosDeReferencia.Telefono"
}
