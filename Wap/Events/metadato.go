...
const MetadatoAvroCRC64Fingerprint = "\xc4\xeb\xf7\xa6/\x89\x19>"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.Wap.DatosDeReferencia.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.Wap.DatosDeReferencia.Metadato"
}
