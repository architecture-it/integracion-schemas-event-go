...
const TelefonoAvroCRC64Fingerprint = "\xfe\xe5\xb3\x03\xf8\x9a\xa5\xba"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Andreani.Wap.Events.Record.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Andreani.Wap.Events.Record.Telefono"
}
