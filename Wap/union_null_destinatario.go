...
func (r *UnionNullDestinatario) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDestinatarioTypeEnumDestinatario:
		return json.Marshal(map[string]interface{}{"Andreani.Wap.Events.Record.Destinatario": r.Destinatario})
	}
...
func (r *UnionNullDestinatario) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.Wap.Events.Record.Destinatario"]; ok {
		r.UnionType = 1
