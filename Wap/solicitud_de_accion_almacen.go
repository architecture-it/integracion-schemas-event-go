...
type SolicitudDeAccionAlmacen struct {
	...
	Planta_instancia *UnionNullString `json:"planta_instancia"`

	ContratoDistribucion *UnionNullString `json:"contratoDistribucion"`

	ContratoWarehousePedido *UnionNullString `json:"contratoWarehousePedido"`
}

const SolicitudDeAccionAlmacenAvroCRC64Fingerprint = "\x9a\xc4'C\xd5\xfb\x15X"

func NewSolicitudDeAccionAlmacen() SolicitudDeAccionAlmacen {
	r := SolicitudDeAccionAlmacen{}
	r.EventoDeNegocio = NewEventoDeNegocio()

	r.Planta_instancia = nil
	r.ContratoDistribucion = nil
	r.ContratoWarehousePedido = nil
	return r
}
...
func writeSolicitudDeAccionAlmacen(r SolicitudDeAccionAlmacen, w io.Writer) error {
	...
	err = writeUnionNullString(r.Planta_instancia, w)
	if err != nil {
		return err
	}
	...
	err = writeUnionNullString(r.ContratoWarehousePedido, w)
	if err != nil {
		return err
	}
	return err
...
func (r *SolicitudDeAccionAlmacen) Get(i int) types.Field {
	...
	case 5:
		r.Planta_instancia = NewUnionNullString()

		return r.Planta_instancia
	case 6:
		r.ContratoDistribucion = NewUnionNullString()

		return r.ContratoDistribucion
	case 7:
		r.ContratoWarehousePedido = NewUnionNullString()

		return r.ContratoWarehousePedido
	}
...
func (r SolicitudDeAccionAlmacen) MarshalJSON() ([]byte, error) {
	...
	output["planta_instancia"], err = json.Marshal(r.Planta_instancia)
	if err != nil {
		return nil, err
	}
	...
	output["contratoWarehousePedido"], err = json.Marshal(r.ContratoWarehousePedido)
	if err != nil {
		return nil, err
	}
...
func (r *SolicitudDeAccionAlmacen) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["planta_instancia"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.Planta_instancia); err != nil {
			return err
		}
	} else {
		r.Planta_instancia = NewUnionNullString()
	...
	val = func() json.RawMessage {
		if v, ok := fields["contratoWarehousePedido"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.ContratoWarehousePedido); err != nil {
			return err
		}
	} else {
		r.ContratoWarehousePedido = NewUnionNullString()
