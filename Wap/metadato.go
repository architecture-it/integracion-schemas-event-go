...
const MetadatoAvroCRC64Fingerprint = "ֻ\xb5\xe4\xd1G\xc1\xe6"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.Wap.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.Wap.Events.Record.Metadato"
}
