...
func (r *UnionNullDatosSucursal) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"codigo\",\"type\":[\"null\",\"string\"]},{\"name\":\"id\",\"type\":[\"null\",\"string\"]},{\"name\":\"nombre\",\"type\":[\"null\",\"string\"]}],\"name\":\"DatosSucursal\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDatosSucursal) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDatosSucursalTypeEnumDatosSucursal:
		return json.Marshal(map[string]interface{}{"Andreani.SppSchema.Events.DatosSucursal": r.DatosSucursal})
	}
...
func (r *UnionNullDatosSucursal) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.SppSchema.Events.DatosSucursal"]; ok {
		r.UnionType = 1
