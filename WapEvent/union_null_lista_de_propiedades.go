...
func (r *UnionNullListaDePropiedades) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDePropiedadesTypeEnumListaDePropiedades:
		return json.Marshal(map[string]interface{}{"Wap.Events.Record.ListaDePropiedades": r.ListaDePropiedades})
	}
...
func (r *UnionNullListaDePropiedades) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Wap.Events.Record.ListaDePropiedades"]; ok {
		r.UnionType = 1
