...
const TelefonoAvroCRC64Fingerprint = "\xb5\xcf{7i\xcd\xf6\x15"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Wap.Events.Record.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Wap.Events.Record.Telefono"
}
