...
func (r *UnionNullListaDeTelefonos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeTelefonosTypeEnumListaDeTelefonos:
		return json.Marshal(map[string]interface{}{"Wap.Events.Record.ListaDeTelefonos": r.ListaDeTelefonos})
	}
...
func (r *UnionNullListaDeTelefonos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Wap.Events.Record.ListaDeTelefonos"]; ok {
		r.UnionType = 1
