...
const ListaDeTelefonosAvroCRC64Fingerprint = "\xc8\"\x12\xed\xceG\xed\xa4"
...
func (r ListaDeTelefonos) Schema() string {
	return "{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Wap.Events.Record.ListaDeTelefonos\",\"type\":\"record\"}"
}

func (r ListaDeTelefonos) SchemaName() string {
	return "Wap.Events.Record.ListaDeTelefonos"
}
