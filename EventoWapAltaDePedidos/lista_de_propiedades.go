...
const ListaDePropiedadesAvroCRC64Fingerprint = "a\xcf\x10U\x89\x1bm\x7f"
...
func (r ListaDePropiedades) Schema() string {
	return "{\"fields\":[{\"name\":\"metadatos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Metadato\",\"namespace\":\"Andreani.Wap.Events.Record\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Andreani.Wap.Events.Record.ListaDePropiedades\",\"type\":\"record\"}"
}
