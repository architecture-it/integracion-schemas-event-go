...
const ListaDeTelefonosAvroCRC64Fingerprint = "\xd2\xc6Y\xd8\xc5!\xe3\b"
...
func (r ListaDeTelefonos) Schema() string {
	return "{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"namespace\":\"Andreani.Wap.Events.Record\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Andreani.Wap.Events.Record.ListaDeTelefonos\",\"type\":\"record\"}"
}

func (r ListaDeTelefonos) SchemaName() string {
	return "Andreani.Wap.Events.Record.ListaDeTelefonos"
}
