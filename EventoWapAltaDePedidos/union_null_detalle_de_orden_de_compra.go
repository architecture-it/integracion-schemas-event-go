...
func (r *UnionNullDetalleDeOrdenDeCompra) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDetalleDeOrdenDeCompraTypeEnumDetalleDeOrdenDeCompra:
		return json.Marshal(map[string]interface{}{"Andreani.Wap.Events.Record.DetalleDeOrdenDeCompra": r.DetalleDeOrdenDeCompra})
	}
...
func (r *UnionNullDetalleDeOrdenDeCompra) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.Wap.Events.Record.DetalleDeOrdenDeCompra"]; ok {
		r.UnionType = 1
