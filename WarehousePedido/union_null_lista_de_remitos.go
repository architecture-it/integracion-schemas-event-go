...
func (r *UnionNullListaDeRemitos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeRemitosTypeEnumListaDeRemitos:
		return json.Marshal(map[string]interface{}{"Andreani.WarehouseAbastecimiento.Events.Record.ListaDeRemitos": r.ListaDeRemitos})
	}
...
func (r *UnionNullListaDeRemitos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.WarehouseAbastecimiento.Events.Record.ListaDeRemitos"]; ok {
		r.UnionType = 1
