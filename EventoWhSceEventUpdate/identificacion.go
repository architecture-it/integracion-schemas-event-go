...
type Identificacion struct {
	...
	TransmitLogKey string `json:"TransmitLogKey"`

	SerialKey int64 `json:"SerialKey"`
}

const IdentificacionAvroCRC64Fingerprint = "R0Y\xbe\x03\x8c\xca\xd7"
...
func writeIdentificacion(r Identificacion, w io.Writer) error {
	...
	err = vm.WriteString(r.TransmitLogKey, w)
	if err != nil {
		return err
	}
	err = vm.WriteLong(r.SerialKey, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Identificacion) Get(i int) types.Field {
	...
	case 9:
		w := types.String{Target: &r.TransmitLogKey}

		return w

	case 10:
		w := types.Long{Target: &r.SerialKey}
...
func (r Identificacion) MarshalJSON() ([]byte, error) {
	...
	output["TransmitLogKey"], err = json.Marshal(r.TransmitLogKey)
	if err != nil {
		return nil, err
	}
...
func (r *Identificacion) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["TransmitLogKey"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.TransmitLogKey); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for TransmitLogKey")
	}
	val = func() json.RawMessage {
