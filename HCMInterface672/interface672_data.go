...
type Interface672Data struct {
	...
	NroDocumento2 *UnionNullString `json:"NroDocumento2"`
...
const Interface672DataAvroCRC64Fingerprint = "c\xf9\xc7\b:\x1d\x01\x85"
...
func writeInterface672Data(r Interface672Data, w io.Writer) error {
	...
	err = writeUnionNullString(r.NroDocumento2, w)
	if err != nil {
		return err
	}
...
func (r Interface672Data) SchemaName() string {
	return "Andreani.HCMInterface672.Events.Record.Interface672Data"
}
...
func (r *Interface672Data) Get(i int) types.Field {
	...
	case 15:
		r.NroDocumento2 = NewUnionNullString()
