...
const PedidoAvroCRC64Fingerprint = "\xbb2\x16W\x86p\x93\xf1"
...
func (r Pedido) Schema() string {
	return "{\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"numeroDePedido\",\"type\":\"int\"},{\"name\":\"cicloDelPedido\",\"type\":\"string\"},{\"name\":\"codigoDeContratoInterno\",\"type\":\"long\"},{\"name\":\"estadoDelPedido\",\"type\":\"string\"},{\"name\":\"cuentaCorriente\",\"type\":\"long\"},{\"name\":\"cuando\",\"type\":\"string\"}],\"name\":\"Andreani.Test.Events.Record.Pedido\",\"type\":\"record\"}"
}

func (r Pedido) SchemaName() string {
	return "Andreani.Test.Events.Record.Pedido"
}
