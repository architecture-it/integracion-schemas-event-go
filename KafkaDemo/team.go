...
const TeamAvroCRC64Fingerprint = "\xd0$\xcarh!/\xef"
...
func (r Team) Schema() string {
	return "{\"fields\":[{\"name\":\"tl\",\"type\":\"string\"},{\"name\":\"boss\",\"type\":\"string\"},{\"name\":\"members\",\"type\":{\"items\":\"string\",\"type\":\"array\"}}],\"name\":\"Andreani.KafkaDemo.Events.Record.Common.Team\",\"type\":\"record\"}"
}

func (r Team) SchemaName() string {
	return "Andreani.KafkaDemo.Events.Record.Common.Team"
}
