...
func (r *UnionNullDatosConstancia) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDatosConstanciaTypeEnumDatosConstancia:
		return json.Marshal(map[string]interface{}{"Andreani.CartaDocumentoBackend.Events.Common.DatosConstancia": r.DatosConstancia})
	}
...
func (r *UnionNullDatosConstancia) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.CartaDocumentoBackend.Events.Common.DatosConstancia"]; ok {
		r.UnionType = 1
