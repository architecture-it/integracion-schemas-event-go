...
func (r *UnionNullDestinatario) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"Nombre\",\"type\":\"string\"},{\"default\":null,\"name\":\"Apellido\",\"type\":[\"null\",\"string\"]},{\"name\":\"Email\",\"type\":\"string\"},{\"name\":\"Telefono\",\"type\":\"string\"},{\"name\":\"Dni\",\"type\":\"string\"}],\"name\":\"Destinatario\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDestinatario) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDestinatarioTypeEnumDestinatario:
		return json.Marshal(map[string]interface{}{"Andreani.CartaDocumentoBackend.Events.Common.Destinatario": r.Destinatario})
	}
...
func (r *UnionNullDestinatario) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.CartaDocumentoBackend.Events.Common.Destinatario"]; ok {
		r.UnionType = 1
