...
const ClienteAvroCRC64Fingerprint = "3P\xeaS\xb7\x9dKM"
...
func (r Cliente) Schema() string {
	return "{\"fields\":[{\"name\":\"CodigoAndreani\",\"type\":\"string\"},{\"name\":\"Nombre\",\"type\":\"string\"},{\"name\":\"Logo\",\"type\":\"string\"}],\"name\":\"Andreani.CartaDocumentoBackend.Events.Common.Cliente\",\"type\":\"record\"}"
}

func (r Cliente) SchemaName() string {
	return "Andreani.CartaDocumentoBackend.Events.Common.Cliente"
}
