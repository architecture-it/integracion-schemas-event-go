...
const PaqueteAvroCRC64Fingerprint = "SyQ\xf7\xc4!\x933"
...
func (r Paquete) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"string\"},{\"name\":\"TipoId\",\"type\":\"string\"},{\"name\":\"Tipo\",\"type\":\"string\"},{\"name\":\"Alto\",\"type\":\"string\"},{\"name\":\"Ancho\",\"type\":\"string\"},{\"name\":\"Largo\",\"type\":\"string\"},{\"name\":\"Peso\",\"type\":\"string\"},{\"name\":\"ValorDeclarado\",\"type\":\"int\"},{\"default\":null,\"name\":\"NumeroDeBulto\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.CartaDocumentoBackend.Events.Common.Paquete\",\"type\":\"record\"}"
}

func (r Paquete) SchemaName() string {
	return "Andreani.CartaDocumentoBackend.Events.Common.Paquete"
}
