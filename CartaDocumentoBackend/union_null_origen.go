...
func (r *UnionNullOrigen) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"Tipo\",\"type\":\"string\"},{\"name\":\"Calle\",\"type\":\"string\"},{\"default\":null,\"name\":\"Numero\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Piso\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Unidad\",\"type\":[\"null\",\"string\"]},{\"name\":\"Localidad\",\"type\":\"string\"},{\"name\":\"CodigoPostal\",\"type\":\"string\"},{\"name\":\"Provincia\",\"type\":\"string\"}],\"name\":\"Origen\",\"type\":\"record\"}]"
}
...
func (r *UnionNullOrigen) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullOrigenTypeEnumOrigen:
		return json.Marshal(map[string]interface{}{"Andreani.CartaDocumentoBackend.Events.Common.Origen": r.Origen})
	}
...
func (r *UnionNullOrigen) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.CartaDocumentoBackend.Events.Common.Origen"]; ok {
		r.UnionType = 1
