...
func (r *UnionNullCotizacion) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullCotizacionTypeEnumCotizacion:
		return json.Marshal(map[string]interface{}{"Andreani.CartaDocumentoBackend.Events.Common.Cotizacion": r.Cotizacion})
	}
...
func (r *UnionNullCotizacion) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.CartaDocumentoBackend.Events.Common.Cotizacion"]; ok {
		r.UnionType = 1
