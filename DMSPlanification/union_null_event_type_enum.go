...
func (r *UnionNullEventTypeEnum) Schema() string {
	return "[\"null\",{\"name\":\"EventTypeEnum\",\"symbols\":[\"CREATED\",\"UPDATED\",\"DELETED\"],\"type\":\"enum\"}]"
}
...
func (r *UnionNullEventTypeEnum) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEventTypeEnumTypeEnumEventTypeEnum:
		return json.Marshal(map[string]interface{}{"Andreani.DMSPlanification.Events.Record.EventTypeEnum": r.EventTypeEnum})
	}
...
func (r *UnionNullEventTypeEnum) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.DMSPlanification.Events.Record.EventTypeEnum"]; ok {
		r.UnionType = 1
