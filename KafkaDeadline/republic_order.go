...
const RepublicOrderAvroCRC64Fingerprint = "K\x01\\\xfe[B\x8d\x9b"
...
func (r RepublicOrder) Schema() string {
	return "{\"fields\":[{\"name\":\"ids\",\"type\":{\"items\":\"string\",\"type\":\"array\"}},{\"name\":\"user\",\"type\":\"string\"}],\"name\":\"Andreani.KafkaDeadline.Events.Record.RepublicOrder\",\"type\":\"record\"}"
}

func (r RepublicOrder) SchemaName() string {
	return "Andreani.KafkaDeadline.Events.Record.RepublicOrder"
}
