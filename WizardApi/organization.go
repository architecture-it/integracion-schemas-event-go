...
const OrganizationAvroCRC64Fingerprint = "\x15\x9bf\n\xd4dcK"
...
func (r Organization) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"long\"},{\"name\":\"Name\",\"type\":\"string\"}],\"name\":\"Andreani.WizardApi.Events.Common.Organization\",\"type\":\"record\"}"
}

func (r Organization) SchemaName() string {
	return "Andreani.WizardApi.Events.Common.Organization"
}
