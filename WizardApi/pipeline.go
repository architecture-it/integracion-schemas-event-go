...
const PipelineAvroCRC64Fingerprint = "\xb0`\x92\v\x87Bu\x1e"
...
func (r Pipeline) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"Name\",\"type\":\"string\"},{\"name\":\"Description\",\"type\":\"string\"},{\"name\":\"RepositoryConfig\",\"type\":\"string\"},{\"name\":\"Deleted\",\"type\":\"boolean\"}],\"name\":\"Andreani.WizardApi.Events.Record.Pipeline\",\"type\":\"record\"}"
}

func (r Pipeline) SchemaName() string {
	return "Andreani.WizardApi.Events.Record.Pipeline"
}
