...
const GithubUserAvroCRC64Fingerprint = "\xaf\x00\x15\xda\u0082 \xe3"
...
func (r GithubUser) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"LoginName\",\"type\":\"string\"},{\"name\":\"UserName\",\"type\":\"string\"},{\"default\":null,\"name\":\"Email\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.WizardApi.Events.Common.GithubUser\",\"type\":\"record\"}"
}

func (r GithubUser) SchemaName() string {
	return "Andreani.WizardApi.Events.Common.GithubUser"
}
