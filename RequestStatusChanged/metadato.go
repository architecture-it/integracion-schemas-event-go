...
const MetadatoAvroCRC64Fingerprint = "ec<\xf4\xed聇"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.RequestStatusChanged.Events.Record.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.RequestStatusChanged.Events.Record.Common.Metadato"
}
