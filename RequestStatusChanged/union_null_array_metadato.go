...
func (r *UnionNullArrayMetadato) Schema() string {
	return "[\"null\",{\"items\":{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Metadato\",\"namespace\":\"Andreani.RequestStatusChanged.Events.Record.Common\",\"type\":\"record\"},\"type\":\"array\"}]"
}
