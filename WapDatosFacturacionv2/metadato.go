...
const MetadatoAvroCRC64Fingerprint = "|(\x95^e@x\x96"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.WapDatosFacturacionv2.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.WapDatosFacturacionv2.Events.Record.Metadato"
}
