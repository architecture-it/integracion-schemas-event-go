...
const EventoDeNegocioAvroCRC64Fingerprint = "P\xed\xe9\x00\xcf\xef\xc5\x17"
...
func (r EventoDeNegocio) Schema() string {
	return "{\"fields\":[{\"name\":\"Timestamp\",\"type\":\"int\"},{\"name\":\"Remitente\",\"type\":\"string\"},{\"default\":null,\"name\":\"Destinatario\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"NumeroDeOrden\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Vencimiento\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.WapDatosFacturacionv2.Events.Record.EventoDeNegocio\",\"type\":\"record\"}"
}

func (r EventoDeNegocio) SchemaName() string {
	return "Andreani.WapDatosFacturacionv2.Events.Record.EventoDeNegocio"
}
