...
const MetadataAvroCRC64Fingerprint = "=m\x9a\xea+\v\x86\xcb"
...
func (r Metadata) Schema() string {
	return "{\"fields\":[{\"name\":\"key\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"string\"}],\"name\":\"Andreani.ComercialPublicador.Events.Record.Metadata\",\"type\":\"record\"}"
}

func (r Metadata) SchemaName() string {
	return "Andreani.ComercialPublicador.Events.Record.Metadata"
}
