...
const DireccionRemitenteAvroCRC64Fingerprint = "\x9ee\xad\xb3\xb2\xbe݇"
...
func (r DireccionRemitente) Schema() string {
	return "{\"fields\":[{\"name\":\"idSucursal\",\"type\":\"int\"},{\"name\":\"calle\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"},{\"name\":\"piso\",\"type\":\"string\"},{\"name\":\"unidad\",\"type\":\"string\"},{\"name\":\"codigoPostal\",\"type\":\"string\"},{\"name\":\"localidad\",\"type\":\"string\"},{\"name\":\"provincia\",\"type\":\"string\"},{\"name\":\"observaciones\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.DireccionRemitente\",\"type\":\"record\"}"
}

func (r DireccionRemitente) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.DireccionRemitente"
}
