...
const RemitenteAvroCRC64Fingerprint = "9\x9c+\x16\x19]=\xc5"
...
func (r Remitente) Schema() string {
	return "{\"fields\":[{\"name\":\"nombre\",\"type\":\"string\"},{\"name\":\"apellido\",\"type\":\"string\"},{\"name\":\"dni\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"telefono\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.Remitente\",\"type\":\"record\"}"
}

func (r Remitente) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.Remitente"
}
