...
const ContentAvroCRC64Fingerprint = "\xd0w\xc59\x85\x19D\xe6"
...
func (r Content) Schema() string {
	return "{\"fields\":[{\"name\":\"envios\",\"type\":{\"items\":{\"fields\":[{\"name\":\"numeroInterno\",\"type\":\"string\"},{\"name\":\"numeroSeguimiento\",\"type\":\"string\"}],\"name\":\"EnvioResponse\",\"type\":\"record\"},\"type\":\"array\"}},{\"name\":\"enviosErroneos\",\"type\":{\"items\":{\"fields\":[{\"name\":\"numeroInterno\",\"type\":\"string\"},{\"name\":\"errorCorpo\",\"type\":\"string\"}],\"name\":\"EnviosErroneo\",\"type\":\"record\"},\"type\":\"array\"}}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.Content\",\"type\":\"record\"}"
}

func (r Content) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.Content"
}
