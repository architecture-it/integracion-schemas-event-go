...
const EnviosErroneoAvroCRC64Fingerprint = "\xc83\xcd\xf1/Z\xddr"
...
func (r EnviosErroneo) Schema() string {
	return "{\"fields\":[{\"name\":\"numeroInterno\",\"type\":\"string\"},{\"name\":\"errorCorpo\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.EnviosErroneo\",\"type\":\"record\"}"
}

func (r EnviosErroneo) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.EnviosErroneo"
}
