...
const DestinatarioAvroCRC64Fingerprint = "<\x11\x06\xae\xac\x0f\xdbP"
...
func (r Destinatario) Schema() string {
	return "{\"fields\":[{\"name\":\"nombre\",\"type\":\"string\"},{\"name\":\"apellido\",\"type\":\"string\"},{\"name\":\"dni\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"telefono\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.Destinatario\",\"type\":\"record\"}"
}

func (r Destinatario) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.Destinatario"
}
