...
const NotificationAvroCRC64Fingerprint = "\x1e\x99X\r\x9a\x13\x01\x8f"
...
func (r Notification) Schema() string {
	return "{\"fields\":[{\"name\":\"code\",\"type\":\"string\"},{\"name\":\"property\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.Notification\",\"type\":\"record\"}"
}

func (r Notification) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.Notification"
}
