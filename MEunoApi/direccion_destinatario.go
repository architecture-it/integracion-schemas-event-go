...
const DireccionDestinatarioAvroCRC64Fingerprint = "\x01%.\xd0#{+\x87"
...
func (r DireccionDestinatario) Schema() string {
	return "{\"fields\":[{\"name\":\"idSucursal\",\"type\":\"int\"},{\"name\":\"calle\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"},{\"name\":\"piso\",\"type\":\"string\"},{\"name\":\"unidad\",\"type\":\"string\"},{\"name\":\"codigoPostal\",\"type\":\"string\"},{\"name\":\"localidad\",\"type\":\"string\"},{\"name\":\"provincia\",\"type\":\"string\"},{\"name\":\"observaciones\",\"type\":\"string\"}],\"name\":\"Andreani.MEunoApi.Events.Record.Structs.DireccionDestinatario\",\"type\":\"record\"}"
}

func (r DireccionDestinatario) SchemaName() string {
	return "Andreani.MEunoApi.Events.Record.Structs.DireccionDestinatario"
}
