...
const DatosDomicilioAvroCRC64Fingerprint = "}$\x81\xfc\xe3\xbb9]"
...
func (r DatosDomicilio) Schema() string {
	return "{\"fields\":[{\"name\":\"AbreviaturaProvincia\",\"type\":\"string\"},{\"name\":\"Calle\",\"type\":\"string\"},{\"name\":\"CodigoCiudad\",\"type\":\"string\"},{\"name\":\"CodigoPostal\",\"type\":\"int\"},{\"name\":\"NombreProvincia\",\"type\":\"string\"},{\"name\":\"Numero\",\"type\":\"int\"}],\"name\":\"Andreani.Facturacion.Events.Common.DatosDomicilio\",\"type\":\"record\"}"
}

func (r DatosDomicilio) SchemaName() string {
	return "Andreani.Facturacion.Events.Common.DatosDomicilio"
}
