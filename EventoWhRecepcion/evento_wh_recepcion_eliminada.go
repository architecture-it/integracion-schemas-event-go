...
type EventoWhRecepcionEliminada struct {
...
const EventoWhRecepcionEliminadaAvroCRC64Fingerprint = "0\n8\xe2]\v\xe0\x90"

func NewEventoWhRecepcionEliminada() EventoWhRecepcionEliminada {
	r := EventoWhRecepcionEliminada{}
...
func DeserializeEventoWhRecepcionEliminada(r io.Reader) (EventoWhRecepcionEliminada, error) {
	t := NewEventoWhRecepcionEliminada()
...
func DeserializeEventoWhRecepcionEliminadaFromSchema(r io.Reader, schema string) (EventoWhRecepcionEliminada, error) {
	t := NewEventoWhRecepcionEliminada()
...
func writeEventoWhRecepcionEliminada(r EventoWhRecepcionEliminada, w io.Writer) error {
	var err error
...
func (r *EventoWhRecepcionEliminada) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhRecepcionEliminada) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhRecepcionEliminada) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhRecepcionEliminada) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhRecepcionEliminada) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhRecepcionEliminada) Finalize()                        {}

func (_ EventoWhRecepcionEliminada) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhRecepcionEliminadaAvroCRC64Fingerprint)
}

func (r EventoWhRecepcionEliminada) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhRecepcionEliminada) UnmarshalJSON(data []byte) error {
