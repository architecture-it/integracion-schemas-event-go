...
/*
 * SOURCE:
 *     EventoWhRecepcionActualizada.avsc
 */
...
type EventoWhRecepcionActualizada struct {
...
const EventoWhRecepcionActualizadaAvroCRC64Fingerprint = "\xb7i\xc9\xc1\x97(p\xed"

func NewEventoWhRecepcionActualizada() EventoWhRecepcionActualizada {
	r := EventoWhRecepcionActualizada{}
...
func DeserializeEventoWhRecepcionActualizada(r io.Reader) (EventoWhRecepcionActualizada, error) {
	t := NewEventoWhRecepcionActualizada()
...
func DeserializeEventoWhRecepcionActualizadaFromSchema(r io.Reader, schema string) (EventoWhRecepcionActualizada, error) {
	t := NewEventoWhRecepcionActualizada()
...
func writeEventoWhRecepcionActualizada(r EventoWhRecepcionActualizada, w io.Writer) error {
	var err error
...
func (r *EventoWhRecepcionActualizada) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhRecepcionActualizada) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhRecepcionActualizada) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhRecepcionActualizada) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhRecepcionActualizada) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhRecepcionActualizada) Finalize()                {}

func (_ EventoWhRecepcionActualizada) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhRecepcionActualizadaAvroCRC64Fingerprint)
}

func (r EventoWhRecepcionActualizada) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhRecepcionActualizada) UnmarshalJSON(data []byte) error {
