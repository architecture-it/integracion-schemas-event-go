...
const DetalleAvroCRC64Fingerprint = "\x9etiq\xf6ry|"
...
func (r Detalle) Schema() string {
	return "{\"fields\":[],\"name\":\"Andreani.EventoWhRecepcion.Events.RecepcionLineaEliminadaCommon.Detalle\",\"type\":\"record\"}"
}

func (r Detalle) SchemaName() string {
	return "Andreani.EventoWhRecepcion.Events.RecepcionLineaEliminadaCommon.Detalle"
}
