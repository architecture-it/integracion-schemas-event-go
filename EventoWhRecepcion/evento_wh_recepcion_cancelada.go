...
/*
 * SOURCE:
 *     EventoWhRecepcionCancelada.avsc
 */
...
type EventoWhRecepcionCancelada struct {
...
const EventoWhRecepcionCanceladaAvroCRC64Fingerprint = "\x853\xbdm\x8cΑ\xdb"

func NewEventoWhRecepcionCancelada() EventoWhRecepcionCancelada {
	r := EventoWhRecepcionCancelada{}
...
func DeserializeEventoWhRecepcionCancelada(r io.Reader) (EventoWhRecepcionCancelada, error) {
	t := NewEventoWhRecepcionCancelada()
...
func DeserializeEventoWhRecepcionCanceladaFromSchema(r io.Reader, schema string) (EventoWhRecepcionCancelada, error) {
	t := NewEventoWhRecepcionCancelada()
...
func writeEventoWhRecepcionCancelada(r EventoWhRecepcionCancelada, w io.Writer) error {
	var err error
...
func (r *EventoWhRecepcionCancelada) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhRecepcionCancelada) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhRecepcionCancelada) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhRecepcionCancelada) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhRecepcionCancelada) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhRecepcionCancelada) Finalize()                        {}

func (_ EventoWhRecepcionCancelada) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhRecepcionCanceladaAvroCRC64Fingerprint)
}

func (r EventoWhRecepcionCancelada) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhRecepcionCancelada) UnmarshalJSON(data []byte) error {
