...
const CabeceraAvroCRC64Fingerprint = "\xbbg\x0f?>%\xa8K"
...
func (r *Cabecera) UnmarshalJSON(data []byte) error {
	...
	if val != nil {
		...
		return fmt.Errorf("no value specified for ReferenciaAlmacen")
	}
	return nil
}
