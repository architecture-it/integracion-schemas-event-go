...
type Cabecera struct {
	...
	LineaRecepcionWH string `json:"LineaRecepcionWH"`
}

const CabeceraAvroCRC64Fingerprint = "[.йgs\x1c\xf8"
...
func writeCabecera(r Cabecera, w io.Writer) error {
	...
	err = vm.WriteString(r.LineaRecepcionWH, w)
	if err != nil {
		return err
	}
	return err
...
func (r Cabecera) Schema() string {
	return "{\"fields\":[{\"name\":\"Propietario\",\"type\":\"string\"},{\"name\":\"RecepcionWH\",\"type\":\"string\"},{\"name\":\"LineaRecepcionWH\",\"type\":\"string\"}],\"name\":\"Andreani.EventoWhRecepcion.Events.RecepcionLineaEliminadaCommon.Cabecera\",\"type\":\"record\"}"
}

func (r Cabecera) SchemaName() string {
	return "Andreani.EventoWhRecepcion.Events.RecepcionLineaEliminadaCommon.Cabecera"
}
...
func (r *Cabecera) Get(i int) types.Field {
	...
	case 2:
		w := types.String{Target: &r.LineaRecepcionWH}
