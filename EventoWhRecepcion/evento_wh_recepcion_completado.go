...
/*
 * SOURCE:
 *     EventoWhRecepcionCompletado.avsc
 */
...
type EventoWhRecepcionCompletado struct {
...
const EventoWhRecepcionCompletadoAvroCRC64Fingerprint = "\x80\x0f\x1f\x02j\xd4\x00\xa1"

func NewEventoWhRecepcionCompletado() EventoWhRecepcionCompletado {
	r := EventoWhRecepcionCompletado{}
...
func DeserializeEventoWhRecepcionCompletado(r io.Reader) (EventoWhRecepcionCompletado, error) {
	t := NewEventoWhRecepcionCompletado()
...
func DeserializeEventoWhRecepcionCompletadoFromSchema(r io.Reader, schema string) (EventoWhRecepcionCompletado, error) {
	t := NewEventoWhRecepcionCompletado()
...
func writeEventoWhRecepcionCompletado(r EventoWhRecepcionCompletado, w io.Writer) error {
	var err error
...
func (r *EventoWhRecepcionCompletado) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhRecepcionCompletado) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhRecepcionCompletado) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhRecepcionCompletado) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhRecepcionCompletado) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhRecepcionCompletado) Finalize()                {}

func (_ EventoWhRecepcionCompletado) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhRecepcionCompletadoAvroCRC64Fingerprint)
}

func (r EventoWhRecepcionCompletado) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhRecepcionCompletado) UnmarshalJSON(data []byte) error {
