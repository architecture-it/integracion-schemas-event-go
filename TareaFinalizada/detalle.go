...
const DetalleAvroCRC64Fingerprint = "0`KK8\xab\x95`"

func NewDetalle() Detalle {
	r := Detalle{}
	r.NumeroLinea = make([]string, 0)
...
func writeDetalle(r Detalle, w io.Writer) error {
	var err error
	err = writeArrayString(r.NumeroLinea, w)
	if err != nil {
		return err
	}
	return err
...
func (r Detalle) Schema() string {
	return "{\"fields\":[{\"name\":\"NumeroLinea\",\"type\":{\"items\":\"string\",\"type\":\"array\"}}],\"name\":\"Andreani.TareaFinalizada.Events.Record.Detalle\",\"type\":\"record\"}"
}

func (r Detalle) SchemaName() string {
	return "Andreani.TareaFinalizada.Events.Record.Detalle"
}
...
func (r *Detalle) Get(i int) types.Field {
	...
	case 0:
		...
		w := ArrayStringWrapper{Target: &r.NumeroLinea}
