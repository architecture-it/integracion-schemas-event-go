...
func writeArticuloContenedorPreparacion(r ArticuloContenedorPreparacion, w io.Writer) error {
	...
	err = writeUnionNullString(r.UbicacionOrigen, w)
	if err != nil {
		return err
	}
	return err
...
func (r ArticuloContenedorPreparacion) MarshalJSON() ([]byte, error) {
	...
	output["UbicacionOrigen"], err = json.Marshal(r.UbicacionOrigen)
	if err != nil {
		return nil, err
	}
...
func (r *ArticuloContenedorPreparacion) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["UbicacionOrigen"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.UbicacionOrigen); err != nil {
			return err
		}
	} else {
		r.UbicacionOrigen = NewUnionNullString()
