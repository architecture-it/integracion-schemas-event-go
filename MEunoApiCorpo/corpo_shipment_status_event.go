...
const CorpoShipmentStatusEventAvroCRC64Fingerprint = "?}\x9b\xea\u0590]\x99"
...
func (r CorpoShipmentStatusEvent) Schema() string {
	return "{\"fields\":[{\"name\":\"TrackingNumber\",\"type\":\"string\"},{\"name\":\"Status\",\"type\":{\"name\":\"CorpoShipmentStatus\",\"namespace\":\"Andreani.MEunoApiCorpo.Events.Record.Structs\",\"symbols\":[\"Pending\",\"Shipped\",\"Delivered\",\"NotDelivered\"],\"type\":\"enum\"}}],\"name\":\"Andreani.MEunoApiCorpo.Events.Record.CorpoShipmentStatusEvent\",\"type\":\"record\"}"
}

func (r CorpoShipmentStatusEvent) SchemaName() string {
	return "Andreani.MEunoApiCorpo.Events.Record.CorpoShipmentStatusEvent"
}
