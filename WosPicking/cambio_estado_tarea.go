...
func writeCambioEstadoTarea(r CambioEstadoTarea, w io.Writer) error {
	...
	err = writeUnionNullBool(r.CambioEstadoExterno, w)
	if err != nil {
		return err
	}
	return err
...
func (r *CambioEstadoTarea) Get(i int) types.Field {
	...
	case 15:
		...
		return r.TiempoReal
	case 16:
		r.CambioEstadoExterno = NewUnionNullBool()

		return r.CambioEstadoExterno
	}
...
func (r CambioEstadoTarea) MarshalJSON() ([]byte, error) {
	...
	output["CambioEstadoExterno"], err = json.Marshal(r.CambioEstadoExterno)
	if err != nil {
		return nil, err
	}
...
func (r *CambioEstadoTarea) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["CambioEstadoExterno"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.CambioEstadoExterno); err != nil {
			return err
		}
	} else {
		r.CambioEstadoExterno = NewUnionNullBool()
