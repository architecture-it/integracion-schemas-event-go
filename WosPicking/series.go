...
const SeriesAvroCRC64Fingerprint = "*9\x81;\vK\xe0\x97"
...
func (r Series) Schema() string {
	return "{\"fields\":[{\"name\":\"Serie\",\"type\":\"string\"}],\"name\":\"Andreani.WosPicking.Events.PriorizacionCommon.Series\",\"type\":\"record\"}"
}

func (r Series) SchemaName() string {
	return "Andreani.WosPicking.Events.PriorizacionCommon.Series"
}
