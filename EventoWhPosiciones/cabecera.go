...
const CabeceraAvroCRC64Fingerprint = "\x16\xa3e\xd30\x80\x14\xf5"
...
func (r Cabecera) Schema() string {
	return "{\"fields\":[{\"name\":\"Ubicacion\",\"type\":[\"null\",\"string\"]},{\"name\":\"TipoUbicacion\",\"type\":[\"null\",\"string\"]},{\"name\":\"CategoriaUbicacion\",\"type\":[\"null\",\"string\"]},{\"name\":\"ABC\",\"type\":[\"null\",\"string\"]},{\"name\":\"Zona\",\"type\":[\"null\",\"string\"]},{\"name\":\"MezclaSKU\",\"type\":[\"null\",\"string\"]},{\"name\":\"MezclaLote\",\"type\":[\"null\",\"string\"]},{\"name\":\"PierdaLpn\",\"type\":[\"null\",\"string\"]},{\"name\":\"CapacidadCubica\",\"type\":[\"null\",\"string\"]},{\"name\":\"CapacidadPeso\",\"type\":[\"null\",\"string\"]},{\"name\":\"Altura\",\"type\":[\"null\",\"string\"]},{\"name\":\"Longitud\",\"type\":[\"null\",\"string\"]},{\"name\":\"Anchura\",\"type\":[\"null\",\"string\"]},{\"name\":\"Nivel\",\"type\":[\"null\",\"string\"]},{\"name\":\"Estado\",\"type\":[\"null\",\"string\"]},{\"name\":\"Temperatura\",\"type\":[\"null\",\"string\"]},{\"name\":\"FormatoUbicacion\",\"type\":[\"null\",\"string\"]},{\"name\":\"FamiliaProducto\",\"type\":[\"null\",\"string\"]},{\"name\":\"Cliente\",\"type\":[\"null\",\"string\"]},{\"name\":\"Situacion\",\"type\":[\"null\",\"string\"]},{\"name\":\"TipoUbicacion2\",\"type\":[\"null\",\"string\"]},{\"name\":\"EuroEquivalente\",\"type\":[\"null\",\"string\"]},{\"name\":\"Llena\",\"type\":[\"null\",\"string\"]},{\"name\":\"Vacia\",\"type\":[\"null\",\"string\"]},{\"name\":\"PorcentajeLleno\",\"type\":[\"null\",\"string\"]},{\"name\":\"CantidadEvento\",\"type\":\"float\"},{\"name\":\"CantidadStock\",\"type\":\"float\"}],\"name\":\"Andreani.EventoWhPosiciones.Events.VaciasCommon.Cabecera\",\"type\":\"record\"}"
}

func (r Cabecera) SchemaName() string {
	return "Andreani.EventoWhPosiciones.Events.VaciasCommon.Cabecera"
}
