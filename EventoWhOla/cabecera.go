...
const CabeceraAvroCRC64Fingerprint = "\xf9\x87\x1b\xdc\xed\xae\x97\x82"
...
func (r Cabecera) Schema() string {
	return "{\"fields\":[{\"name\":\"Ola\",\"type\":\"string\"}],\"name\":\"Andreani.EventoWhOla.Events.LanzadaCommon.Cabecera\",\"type\":\"record\"}"
}

func (r Cabecera) SchemaName() string {
	return "Andreani.EventoWhOla.Events.LanzadaCommon.Cabecera"
}
