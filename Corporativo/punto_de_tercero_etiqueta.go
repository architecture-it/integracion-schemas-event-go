...
type PuntoDeTerceroEtiqueta struct {
	...
	Direccion DireccionPuntoDeTerceroEtiqueta `json:"Direccion"`
...
func NewPuntoDeTerceroEtiqueta() PuntoDeTerceroEtiqueta {
	...
	r.Direccion = NewDireccionPuntoDeTerceroEtiqueta()

	return r
}

func DeserializePuntoDeTerceroEtiqueta(r io.Reader) (PuntoDeTerceroEtiqueta, error) {
	t := NewPuntoDeTerceroEtiqueta()
...
func DeserializePuntoDeTerceroEtiquetaFromSchema(r io.Reader, schema string) (PuntoDeTerceroEtiqueta, error) {
	t := NewPuntoDeTerceroEtiqueta()
...
func writePuntoDeTerceroEtiqueta(r PuntoDeTerceroEtiqueta, w io.Writer) error {
	var err error
	...
	err = writeDireccionPuntoDeTerceroEtiqueta(r.Direccion, w)
	if err != nil {
		return err
	}
...
func (r PuntoDeTerceroEtiqueta) Serialize(w io.Writer) error {
	return writePuntoDeTerceroEtiqueta(r, w)
}
...
func (_ PuntoDeTerceroEtiqueta) SetInt(v int32)       { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetLong(v int64)      { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetString(v string)   { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *PuntoDeTerceroEtiqueta) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *PuntoDeTerceroEtiqueta) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *PuntoDeTerceroEtiqueta) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ PuntoDeTerceroEtiqueta) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) HintSize(int)                     { panic("Unsupported operation") }
func (_ PuntoDeTerceroEtiqueta) Finalize()                        {}

func (_ PuntoDeTerceroEtiqueta) AvroCRC64Fingerprint() []byte {
	return []byte(PuntoDeTerceroEtiquetaAvroCRC64Fingerprint)
}

func (r PuntoDeTerceroEtiqueta) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *PuntoDeTerceroEtiqueta) UnmarshalJSON(data []byte) error {
