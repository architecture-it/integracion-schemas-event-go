...
const ListaDeRemitosAvroCRC64Fingerprint = "\b\xf8ćvg|\xa2"
...
func (r ListaDeRemitos) Schema() string {
	return "{\"fields\":[{\"name\":\"documentos\",\"type\":{\"items\":{\"fields\":[{\"name\":\"numeroEntidad\",\"type\":\"string\"},{\"name\":\"documento\",\"type\":\"string\"}],\"name\":\"Remito\",\"type\":\"record\"},\"type\":\"array\"}}],\"name\":\"Andreani.Wapv2.Events.Record.ListaDeRemitos\",\"type\":\"record\"}"
}

func (r ListaDeRemitos) SchemaName() string {
	return "Andreani.Wapv2.Events.Record.ListaDeRemitos"
}
