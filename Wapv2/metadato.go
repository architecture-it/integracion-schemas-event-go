...
const MetadatoAvroCRC64Fingerprint = "r\xea\x87,\xf1E\xa2y"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.Wapv2.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.Wapv2.Events.Record.Metadato"
}
