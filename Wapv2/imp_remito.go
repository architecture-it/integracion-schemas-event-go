...
const ImpRemitoAvroCRC64Fingerprint = "\xb5P\x0f\xfd&0\xbb\xe2"
...
func (r ImpRemito) Schema() string {
	return "{\"fields\":[{\"name\":\"value\",\"type\":\"string\"}],\"name\":\"Andreani.Wapv2.Events.Record.ImpRemito\",\"type\":\"record\"}"
}

func (r ImpRemito) SchemaName() string {
	return "Andreani.Wapv2.Events.Record.ImpRemito"
}
