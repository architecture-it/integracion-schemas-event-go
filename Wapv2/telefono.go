...
const TelefonoAvroCRC64Fingerprint = "\x1c^\x1e\x8e\xae\x1b \x06"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Andreani.Wapv2.Events.Record.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Andreani.Wapv2.Events.Record.Telefono"
}
