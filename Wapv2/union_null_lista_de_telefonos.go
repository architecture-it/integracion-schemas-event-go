...
func (r *UnionNullListaDeTelefonos) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"default\":null,\"name\":\"tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"ListaDeTelefonos\",\"type\":\"record\"}]"
}
...
func (r *UnionNullListaDeTelefonos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeTelefonosTypeEnumListaDeTelefonos:
		return json.Marshal(map[string]interface{}{"Andreani.Wapv2.Events.Record.ListaDeTelefonos": r.ListaDeTelefonos})
	}
...
func (r *UnionNullListaDeTelefonos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.Wapv2.Events.Record.ListaDeTelefonos"]; ok {
		r.UnionType = 1
