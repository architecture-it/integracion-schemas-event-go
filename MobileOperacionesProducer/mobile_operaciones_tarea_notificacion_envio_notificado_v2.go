...
/*
 * SOURCE:
 *     MobileOperacionesTareaNotificacionEnvioNotificadoV2.avsc
 */
...
type MobileOperacionesTareaNotificacionEnvioNotificadoV2 struct {
...
func DeserializeMobileOperacionesTareaNotificacionEnvioNotificadoV2(r io.Reader) (MobileOperacionesTareaNotificacionEnvioNotificadoV2, error) {
	t := NewMobileOperacionesTareaNotificacionEnvioNotificadoV2()
...
func DeserializeMobileOperacionesTareaNotificacionEnvioNotificadoV2FromSchema(r io.Reader, schema string) (MobileOperacionesTareaNotificacionEnvioNotificadoV2, error) {
	t := NewMobileOperacionesTareaNotificacionEnvioNotificadoV2()
...
func writeMobileOperacionesTareaNotificacionEnvioNotificadoV2(r MobileOperacionesTareaNotificacionEnvioNotificadoV2, w io.Writer) error {
	var err error
...
func (r MobileOperacionesTareaNotificacionEnvioNotificadoV2) Serialize(w io.Writer) error {
	return writeMobileOperacionesTareaNotificacionEnvioNotificadoV2(r, w)
}
...
func (r MobileOperacionesTareaNotificacionEnvioNotificadoV2) SchemaName() string {
	return "Andreani.MobileOperacionesProducer.Events.Record.MobileOperacionesTareaNotificacionEnvioNotificadoV2"
}

func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetBoolean(v bool) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetInt(v int32) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetLong(v int64) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetFloat(v float32) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetDouble(v float64) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetBytes(v []byte) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetString(v string) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetUnionElem(v int64) {
	panic("Unsupported operation")
}

func (r *MobileOperacionesTareaNotificacionEnvioNotificadoV2) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *MobileOperacionesTareaNotificacionEnvioNotificadoV2) SetDefault(i int) {
	switch i {
	case 0:
		r.Id = nil
		return
...
func (r *MobileOperacionesTareaNotificacionEnvioNotificadoV2) NullField(i int) {
	switch i {
	case 0:
		r.Id = nil
		return
...
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) AppendArray() types.Field {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) HintSize(int) {
	panic("Unsupported operation")
}
func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) Finalize() {}

func (_ MobileOperacionesTareaNotificacionEnvioNotificadoV2) AvroCRC64Fingerprint() []byte {
	return []byte(MobileOperacionesTareaNotificacionEnvioNotificadoV2AvroCRC64Fingerprint)
}

func (r MobileOperacionesTareaNotificacionEnvioNotificadoV2) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *MobileOperacionesTareaNotificacionEnvioNotificadoV2) UnmarshalJSON(data []byte) error {
