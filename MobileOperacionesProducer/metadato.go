...
const MetadatoAvroCRC64Fingerprint = "=1w\xfd\x9d\x06gm"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"default\":null,\"name\":\"contenido\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.MobileOperacionesProducer.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.MobileOperacionesProducer.Events.Record.Metadato"
}
