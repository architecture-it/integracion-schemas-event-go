...
func (r *UnionNullDestinatario) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"Nombre\",\"type\":\"string\"},{\"name\":\"Apellido\",\"type\":\"string\"},{\"name\":\"TipoDocumento\",\"type\":\"int\"}],\"name\":\"Destinatario\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDestinatario) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDestinatarioTypeEnumDestinatario:
		return json.Marshal(map[string]interface{}{"Andreani.WosTrazabilidad.Events.AnmatCommon.Destinatario": r.Destinatario})
	}
...
func (r *UnionNullDestinatario) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.WosTrazabilidad.Events.AnmatCommon.Destinatario"]; ok {
		r.UnionType = 1
