...
const MetadatoAvroCRC64Fingerprint = "\n\x8d\x1fR\x15\xff\x13U"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.DistribucionPedido.Events.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.DistribucionPedido.Events.Common.Metadato"
}
