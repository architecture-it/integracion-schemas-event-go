...
/*
 * SOURCE:
 *     BultoExpedicionHojaDeRutaDeViaje.avsc
 */
...
type BultoExpedicionHojaDeRutaDeViaje struct {
...
const BultoExpedicionHojaDeRutaDeViajeAvroCRC64Fingerprint = "/\xca.\f\t\xe6\xdd<"

func NewBultoExpedicionHojaDeRutaDeViaje() BultoExpedicionHojaDeRutaDeViaje {
	r := BultoExpedicionHojaDeRutaDeViaje{}
...
func DeserializeBultoExpedicionHojaDeRutaDeViaje(r io.Reader) (BultoExpedicionHojaDeRutaDeViaje, error) {
	t := NewBultoExpedicionHojaDeRutaDeViaje()
...
func DeserializeBultoExpedicionHojaDeRutaDeViajeFromSchema(r io.Reader, schema string) (BultoExpedicionHojaDeRutaDeViaje, error) {
	t := NewBultoExpedicionHojaDeRutaDeViaje()
...
func writeBultoExpedicionHojaDeRutaDeViaje(r BultoExpedicionHojaDeRutaDeViaje, w io.Writer) error {
	var err error
...
func (r *BultoExpedicionHojaDeRutaDeViaje) SetDefault(i int) {
	switch i {
	case 2:
		r.Distribuidor = nil
		return
...
func (r *BultoExpedicionHojaDeRutaDeViaje) NullField(i int) {
	switch i {
	case 2:
		r.Distribuidor = nil
		return
...
func (_ BultoExpedicionHojaDeRutaDeViaje) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ BultoExpedicionHojaDeRutaDeViaje) AppendArray() types.Field { panic("Unsupported operation") }
func (_ BultoExpedicionHojaDeRutaDeViaje) HintSize(int)             { panic("Unsupported operation") }
func (_ BultoExpedicionHojaDeRutaDeViaje) Finalize()                {}

func (_ BultoExpedicionHojaDeRutaDeViaje) AvroCRC64Fingerprint() []byte {
	return []byte(BultoExpedicionHojaDeRutaDeViajeAvroCRC64Fingerprint)
}

func (r BultoExpedicionHojaDeRutaDeViaje) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *BultoExpedicionHojaDeRutaDeViaje) UnmarshalJSON(data []byte) error {
