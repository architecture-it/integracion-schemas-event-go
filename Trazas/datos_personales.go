...
type DatosPersonales struct {
	...
	Telefonos *UnionNullArrayTelefono `json:"telefonos"`
...
const DatosPersonalesAvroCRC64Fingerprint = "+\xf9\xb1\x97\xcd9E\xe3"
...
func writeDatosPersonales(r DatosPersonales, w io.Writer) error {
	...
	err = writeUnionNullArrayTelefono(r.Telefonos, w)
	if err != nil {
		return err
	}
...
func (r DatosPersonales) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"numeroDeDocumento\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"nombreCompleto\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"idInternoDelCliente\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"eMail\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"telefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"tipo\",\"type\":{\"name\":\"TipoDeTelefono\",\"symbols\":[\"trabajo\",\"celular\",\"casa\",\"otro\"],\"type\":\"enum\"}},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]},{\"default\":null,\"name\":\"agrupador\",\"type\":[\"null\",\"string\"]},{\"name\":\"tipoDeDocumento\",\"type\":{\"name\":\"TipoDeDocumento\",\"symbols\":[\"undefined\",\"DNI\",\"CUIT\",\"CUIL\"],\"type\":\"enum\"}}],\"name\":\"Integracion.Esquemas.Referencias.DatosPersonales\",\"type\":\"record\"}"
}

func (r DatosPersonales) SchemaName() string {
	return "Integracion.Esquemas.Referencias.DatosPersonales"
}
...
func (r *DatosPersonales) Get(i int) types.Field {
	...
	case 3:
		...
		return r.EMail
	case 4:
		r.Telefonos = NewUnionNullArrayTelefono()
