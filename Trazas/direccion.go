...
type Direccion struct {
	...
	ComponentesDeDireccion *UnionNullMapString `json:"componentesDeDireccion"`

	Coordenadas *UnionNullGeoReferencia `json:"coordenadas"`
}

const DireccionAvroCRC64Fingerprint = "\xa5\xc6\xd0\xfb\xec\x93]Y"
...
func writeDireccion(r Direccion, w io.Writer) error {
	...
	err = writeUnionNullMapString(r.ComponentesDeDireccion, w)
	if err != nil {
		return err
	}
	err = writeUnionNullGeoReferencia(r.Coordenadas, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Direccion) Get(i int) types.Field {
	...
	case 10:
		...
		return r.Localidad
	case 11:
		r.ComponentesDeDireccion = NewUnionNullMapString()

		return r.ComponentesDeDireccion
	case 12:
		r.Coordenadas = NewUnionNullGeoReferencia()
