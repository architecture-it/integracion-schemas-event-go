...
func (r *UnionNullDatosPersonales) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDatosPersonalesTypeEnumDatosPersonales:
		return json.Marshal(map[string]interface{}{"Integracion.Esquemas.Referencias.DatosPersonales": r.DatosPersonales})
	}
...
func (r *UnionNullDatosPersonales) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Integracion.Esquemas.Referencias.DatosPersonales"]; ok {
		r.UnionType = 1
