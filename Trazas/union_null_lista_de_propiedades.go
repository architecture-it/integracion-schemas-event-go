...
func (r *UnionNullListaDePropiedades) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"metadatos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Metadato\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"ListaDePropiedades\",\"namespace\":\"Integracion.Esquemas.Referencias\",\"type\":\"record\"}]"
}
...
func (r *UnionNullListaDePropiedades) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDePropiedadesTypeEnumListaDePropiedades:
		return json.Marshal(map[string]interface{}{"Integracion.Esquemas.Referencias.ListaDePropiedades": r.ListaDePropiedades})
	}
...
func (r *UnionNullListaDePropiedades) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Integracion.Esquemas.Referencias.ListaDePropiedades"]; ok {
		r.UnionType = 1
