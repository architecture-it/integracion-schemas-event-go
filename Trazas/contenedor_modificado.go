...
type ContenedorModificado struct {
...
const ContenedorModificadoAvroCRC64Fingerprint = "\xefVhh3\x02K7"
...
func DeserializeContenedorModificado(r io.Reader) (ContenedorModificado, error) {
	t := NewContenedorModificado()
...
func DeserializeContenedorModificadoFromSchema(r io.Reader, schema string) (ContenedorModificado, error) {
	t := NewContenedorModificado()
...
func writeContenedorModificado(r ContenedorModificado, w io.Writer) error {
	var err error
...
func (r ContenedorModificado) Serialize(w io.Writer) error {
	return writeContenedorModificado(r, w)
}
...
func (r ContenedorModificado) SchemaName() string {
	return "Integracion.Esquemas.Contenedor.Trazas.ContenedorModificado"
}

func (_ ContenedorModificado) SetBoolean(v bool)    { panic("Unsupported operation") }
func (_ ContenedorModificado) SetInt(v int32)       { panic("Unsupported operation") }
func (_ ContenedorModificado) SetLong(v int64)      { panic("Unsupported operation") }
func (_ ContenedorModificado) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ ContenedorModificado) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ ContenedorModificado) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ ContenedorModificado) SetString(v string)   { panic("Unsupported operation") }
func (_ ContenedorModificado) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *ContenedorModificado) Get(i int) types.Field {
	switch i {
	case 0:
		r.Traza = NewTrazaContendor()
...
func (_ ContenedorModificado) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ ContenedorModificado) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ ContenedorModificado) HintSize(int)                     { panic("Unsupported operation") }
func (_ ContenedorModificado) Finalize()                        {}

func (_ ContenedorModificado) AvroCRC64Fingerprint() []byte {
	return []byte(ContenedorModificadoAvroCRC64Fingerprint)
}

func (r ContenedorModificado) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *ContenedorModificado) UnmarshalJSON(data []byte) error {
