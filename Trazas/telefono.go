...
type Telefono struct {
	Tipo TipoDeTelefono `json:"tipo"`

	Numero string `json:"numero"`
}

const TelefonoAvroCRC64Fingerprint = "s\xa0\xd6T\xfb\xc6\x01\xce"
...
func writeTelefono(r Telefono, w io.Writer) error {
	var err error
	err = writeTipoDeTelefono(r.Tipo, w)
	if err != nil {
		return err
	}
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"name\":\"tipo\",\"type\":{\"name\":\"TipoDeTelefono\",\"symbols\":[\"trabajo\",\"celular\",\"casa\",\"otro\"],\"type\":\"enum\"}},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Integracion.Esquemas.Referencias.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Integracion.Esquemas.Referencias.Telefono"
}
...
func (r *Telefono) Get(i int) types.Field {
	switch i {
	case 0:
		w := TipoDeTelefonoWrapper{Target: &r.Tipo}
