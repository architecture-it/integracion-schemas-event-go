...
const (
	TiposDePruebasPull    TiposDePruebas = 0
	TiposDePruebasRequest TiposDePruebas = 1
	TiposDePruebasAvro    TiposDePruebas = 2
)

func (e TiposDePruebas) String() string {
	switch e {
	case TiposDePruebasPull:
		return "Pull"
	case TiposDePruebasRequest:
		return "Request"
	case TiposDePruebasAvro:
		return "Avro"
	}
	return "unknown"
}
...
func NewTiposDePruebasValue(raw string) (r TiposDePruebas, err error) {
	switch raw {
	case "Pull":
		return TiposDePruebasPull, nil
	case "Request":
		return TiposDePruebasRequest, nil
	case "Avro":
		return TiposDePruebasAvro, nil
	}
