...
func (r *UnionNullDatosSucursal) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"codigo\",\"type\":\"string\"},{\"default\":null,\"name\":\"nombre\",\"type\":[\"null\",\"string\"]},{\"name\":\"id\",\"type\":\"string\"}],\"name\":\"DatosSucursal\",\"namespace\":\"Integracion.Esquemas.Referencias\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDatosSucursal) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDatosSucursalTypeEnumDatosSucursal:
		return json.Marshal(map[string]interface{}{"Integracion.Esquemas.Referencias.DatosSucursal": r.DatosSucursal})
	}
...
func (r *UnionNullDatosSucursal) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Integracion.Esquemas.Referencias.DatosSucursal"]; ok {
		r.UnionType = 1
