...
const BultoVisitaAvroCRC64Fingerprint = "\x82\xa7f\xdc\xceY\xf1A"

func NewBultoVisita() BultoVisita {
	r := BultoVisita{}
...
func DeserializeBultoVisita(r io.Reader) (BultoVisita, error) {
	t := NewBultoVisita()
...
func DeserializeBultoVisitaFromSchema(r io.Reader, schema string) (BultoVisita, error) {
	t := NewBultoVisita()
...
func writeBultoVisita(r BultoVisita, w io.Writer) error {
	var err error
...
func (r *BultoVisita) SetDefault(i int) {
	switch i {
	case 1:
		r.Motivo = nil
		return
...
func (r *BultoVisita) NullField(i int) {
	switch i {
	case 1:
		r.Motivo = nil
		return
...
func (_ BultoVisita) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ BultoVisita) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ BultoVisita) HintSize(int)                     { panic("Unsupported operation") }
func (_ BultoVisita) Finalize()                        {}

func (_ BultoVisita) AvroCRC64Fingerprint() []byte {
	return []byte(BultoVisitaAvroCRC64Fingerprint)
}

func (r BultoVisita) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *BultoVisita) UnmarshalJSON(data []byte) error {
