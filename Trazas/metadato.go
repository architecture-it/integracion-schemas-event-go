...
const MetadatoAvroCRC64Fingerprint = "両\x92H\xc8\x03\xcf"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Integracion.Esquemas.Referencias.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Integracion.Esquemas.Referencias.Metadato"
}
