...
type RespuestasPreonboarding struct {
...
const RespuestasPreonboardingAvroCRC64Fingerprint = "\xf2}\xa5\xce\xc2\x16\xb1'"

func NewRespuestasPreonboarding() RespuestasPreonboarding {
	r := RespuestasPreonboarding{}
	r.IdFormulario = nil
...
func DeserializeRespuestasPreonboarding(r io.Reader) (RespuestasPreonboarding, error) {
	t := NewRespuestasPreonboarding()
...
func DeserializeRespuestasPreonboardingFromSchema(r io.Reader, schema string) (RespuestasPreonboarding, error) {
	t := NewRespuestasPreonboarding()
...
func writeRespuestasPreonboarding(r RespuestasPreonboarding, w io.Writer) error {
	var err error
...
func (r RespuestasPreonboarding) Serialize(w io.Writer) error {
	return writeRespuestasPreonboarding(r, w)
}

func (r RespuestasPreonboarding) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"IdFormulario\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"TituloFormulario\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Nombre\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Apellido\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Telefono\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Mail\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"IdOrigen\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"DescripcionOrigen\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.NotificacionesMarketing.Events.Record.RespuestasPreonboarding\",\"type\":\"record\"}"
}

func (r RespuestasPreonboarding) SchemaName() string {
	return "Andreani.NotificacionesMarketing.Events.Record.RespuestasPreonboarding"
}

func (_ RespuestasPreonboarding) SetBoolean(v bool)    { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetInt(v int32)       { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetLong(v int64)      { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetString(v string)   { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *RespuestasPreonboarding) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *RespuestasPreonboarding) SetDefault(i int) {
	switch i {
	case 0:
		r.IdFormulario = nil
		return
...
func (r *RespuestasPreonboarding) NullField(i int) {
	switch i {
	case 0:
		r.IdFormulario = nil
		return
...
func (_ RespuestasPreonboarding) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) HintSize(int)                     { panic("Unsupported operation") }
func (_ RespuestasPreonboarding) Finalize()                        {}

func (_ RespuestasPreonboarding) AvroCRC64Fingerprint() []byte {
	return []byte(RespuestasPreonboardingAvroCRC64Fingerprint)
}

func (r RespuestasPreonboarding) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *RespuestasPreonboarding) UnmarshalJSON(data []byte) error {
