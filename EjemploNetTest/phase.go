...
const PhaseAvroCRC64Fingerprint = "ߒQ\xc7\x05\x80\x9b\xfe"
...
func (r Phase) Schema() string {
	return "{\"fields\":[{\"name\":\"Token\",\"type\":\"string\"},{\"name\":\"Tenant\",\"type\":\"string\"}],\"name\":\"Andreani.EjemploNetTest.Events.Records.Phase\",\"type\":\"record\"}"
}

func (r Phase) SchemaName() string {
	return "Andreani.EjemploNetTest.Events.Records.Phase"
}
