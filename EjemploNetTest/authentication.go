...
const AuthenticationAvroCRC64Fingerprint = "\xa7~\xc1D\xf5\x18o\x8c"
...
func (r Authentication) Schema() string {
	return "{\"fields\":[{\"name\":\"token\",\"type\":\"string\"},{\"name\":\"tenant\",\"type\":\"string\"}],\"name\":\"Andreani.EjemploNetTest.Events.Records.Authentication\",\"type\":\"record\"}"
}

func (r Authentication) SchemaName() string {
	return "Andreani.EjemploNetTest.Events.Records.Authentication"
}
