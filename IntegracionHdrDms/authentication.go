...
const AuthenticationAvroCRC64Fingerprint = "\xe7J\xc0\xac\r\xfd\n\x00"
...
func (r Authentication) Schema() string {
	return "{\"fields\":[{\"name\":\"token\",\"type\":\"string\"},{\"name\":\"tenant\",\"type\":\"string\"}],\"name\":\"Andreani.IntegracionHdrDms.Events.Record.Authentication\",\"type\":\"record\"}"
}

func (r Authentication) SchemaName() string {
	return "Andreani.IntegracionHdrDms.Events.Record.Authentication"
}
