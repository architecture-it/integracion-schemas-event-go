...
const PhaseAvroCRC64Fingerprint = "\xfe\r\xd0\xe8t\x17#C"
...
func (r Phase) Schema() string {
	return "{\"fields\":[{\"name\":\"Token\",\"type\":\"string\"},{\"name\":\"Tenant\",\"type\":\"string\"},{\"default\":null,\"name\":\"Data\",\"type\":[\"null\",{\"fields\":[{\"name\":\"EndDate\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}},{\"name\":\"StartDate\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}},{\"default\":null,\"name\":\"AdvanceNotice\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"DecouplingCause\",\"type\":[\"null\",\"string\"]},{\"name\":\"Compensation\",\"type\":\"boolean\"},{\"name\":\"Holidays\",\"type\":\"boolean\"},{\"name\":\"Real\",\"type\":\"boolean\"},{\"name\":\"RecognizedStartDate\",\"type\":\"boolean\"},{\"name\":\"Salary\",\"type\":\"boolean\"},{\"name\":\"Status\",\"type\":\"boolean\"},{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"EmployeeId\",\"type\":\"int\"}],\"name\":\"PhaseData\",\"namespace\":\"Andreani.IntegracionHdrDms.Events.Common\",\"type\":\"record\"}]}],\"name\":\"Andreani.IntegracionHdrDms.Events.Record.Phase\",\"type\":\"record\"}"
}

func (r Phase) SchemaName() string {
	return "Andreani.IntegracionHdrDms.Events.Record.Phase"
}
