...
func (r *UnionNullPhaseData) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"EndDate\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}},{\"name\":\"StartDate\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}},{\"default\":null,\"name\":\"AdvanceNotice\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"DecouplingCause\",\"type\":[\"null\",\"string\"]},{\"name\":\"Compensation\",\"type\":\"boolean\"},{\"name\":\"Holidays\",\"type\":\"boolean\"},{\"name\":\"Real\",\"type\":\"boolean\"},{\"name\":\"RecognizedStartDate\",\"type\":\"boolean\"},{\"name\":\"Salary\",\"type\":\"boolean\"},{\"name\":\"Status\",\"type\":\"boolean\"},{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"EmployeeId\",\"type\":\"int\"}],\"name\":\"PhaseData\",\"namespace\":\"Andreani.IntegracionHdrDms.Events.Common\",\"type\":\"record\"}]"
}
...
func (r *UnionNullPhaseData) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullPhaseDataTypeEnumPhaseData:
		return json.Marshal(map[string]interface{}{"Andreani.IntegracionHdrDms.Events.Common.PhaseData": r.PhaseData})
	}
...
func (r *UnionNullPhaseData) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.IntegracionHdrDms.Events.Common.PhaseData"]; ok {
		r.UnionType = 1
