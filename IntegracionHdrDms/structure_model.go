...
const StructureModelAvroCRC64Fingerprint = "{\u0381\x8d\aӉ\x14"
...
func (r StructureModel) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"Description\",\"type\":\"string\"}],\"name\":\"Andreani.IntegracionHdrDms.Events.Common.StructureModel\",\"type\":\"record\"}"
}

func (r StructureModel) SchemaName() string {
	return "Andreani.IntegracionHdrDms.Events.Common.StructureModel"
}
