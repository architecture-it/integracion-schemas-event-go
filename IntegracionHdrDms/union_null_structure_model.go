...
func (r *UnionNullStructureModel) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullStructureModelTypeEnumStructureModel:
		return json.Marshal(map[string]interface{}{"Andreani.IntegracionHdrDms.Events.Common.StructureModel": r.StructureModel})
	}
...
func (r *UnionNullStructureModel) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.IntegracionHdrDms.Events.Common.StructureModel"]; ok {
		r.UnionType = 1
