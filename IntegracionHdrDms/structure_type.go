...
const StructureTypeAvroCRC64Fingerprint = "p\"3ځ}\x12\x81"
...
func (r StructureType) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"Description\",\"type\":\"string\"}],\"name\":\"Andreani.IntegracionHdrDms.Events.Common.StructureType\",\"type\":\"record\"}"
}

func (r StructureType) SchemaName() string {
	return "Andreani.IntegracionHdrDms.Events.Common.StructureType"
}
