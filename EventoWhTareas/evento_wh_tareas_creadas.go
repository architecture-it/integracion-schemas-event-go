...
type EventoWhTareasCreadas struct {
...
const EventoWhTareasCreadasAvroCRC64Fingerprint = "\x01\xd0W\x8d\xbe\xa2\x17\xeb"

func NewEventoWhTareasCreadas() EventoWhTareasCreadas {
	r := EventoWhTareasCreadas{}
...
func DeserializeEventoWhTareasCreadas(r io.Reader) (EventoWhTareasCreadas, error) {
	t := NewEventoWhTareasCreadas()
...
func DeserializeEventoWhTareasCreadasFromSchema(r io.Reader, schema string) (EventoWhTareasCreadas, error) {
	t := NewEventoWhTareasCreadas()
...
func writeEventoWhTareasCreadas(r EventoWhTareasCreadas, w io.Writer) error {
	var err error
...
func (r *EventoWhTareasCreadas) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhTareasCreadas) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhTareasCreadas) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhTareasCreadas) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhTareasCreadas) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhTareasCreadas) Finalize()                        {}

func (_ EventoWhTareasCreadas) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhTareasCreadasAvroCRC64Fingerprint)
}

func (r EventoWhTareasCreadas) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhTareasCreadas) UnmarshalJSON(data []byte) error {
