...
type Notificaciones struct {
	...
	IdUrlSalida int32 `json:"IdUrlSalida"`
}

const NotificacionesAvroCRC64Fingerprint = "\x06=\xacm^\rڱ"
...
func writeNotificaciones(r Notificaciones, w io.Writer) error {
	...
	err = vm.WriteInt(r.IdUrlSalida, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Notificaciones) Get(i int) types.Field {
	...
	case 26:
		w := types.Int{Target: &r.IdUrlSalida}
...
func (r Notificaciones) MarshalJSON() ([]byte, error) {
	...
	output["IdUrlSalida"], err = json.Marshal(r.IdUrlSalida)
	if err != nil {
		return nil, err
	}
...
func (r *Notificaciones) UnmarshalJSON(data []byte) error {
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.IdUrlSalida); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for IdUrlSalida")
	}
	return nil
}
