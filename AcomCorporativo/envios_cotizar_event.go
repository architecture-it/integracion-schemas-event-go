...
const EnviosCotizarEventAvroCRC64Fingerprint = "f@\x16\x98ʝv+"
...
func (r EnviosCotizarEvent) Schema() string {
	return "{\"fields\":[{\"name\":\"Envios\",\"type\":{\"items\":{\"fields\":[{\"name\":\"Id\",\"type\":\"string\"},{\"name\":\"NumeroContrato\",\"type\":\"string\"},{\"name\":\"Cliente\",\"type\":\"string\"},{\"name\":\"CodigoPostalOrigenId\",\"type\":\"string\"},{\"name\":\"CodigoPostalDestino\",\"type\":\"string\"},{\"name\":\"Peso\",\"type\":\"string\"},{\"name\":\"Volumen\",\"type\":\"string\"},{\"name\":\"ValorDeclarado\",\"type\":\"string\"},{\"name\":\"AltoCm\",\"type\":\"string\"},{\"name\":\"AnchoCm\",\"type\":\"string\"},{\"name\":\"LargoCm\",\"type\":\"string\"},{\"name\":\"TipoDeEnvioId\",\"type\":\"string\"},{\"name\":\"ItemId\",\"type\":\"string\"},{\"name\":\"PesoUnidad\",\"type\":\"string\"}],\"name\":\"Envio\",\"namespace\":\"Andreani.CorpoCotizar.Events.Common\",\"type\":\"record\"},\"type\":\"array\"}}],\"name\":\"Andreani.CorpoCotizar.Events.Record.EnviosCotizarEvent\",\"type\":\"record\"}"
}

func (r EnviosCotizarEvent) SchemaName() string {
	return "Andreani.CorpoCotizar.Events.Record.EnviosCotizarEvent"
}
