...
const EnvioAvroCRC64Fingerprint = "eS\xeaok\x99\x9e\xe5"
...
func (r Envio) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"string\"},{\"name\":\"NumeroContrato\",\"type\":\"string\"},{\"name\":\"Cliente\",\"type\":\"string\"},{\"name\":\"CodigoPostalOrigenId\",\"type\":\"string\"},{\"name\":\"CodigoPostalDestino\",\"type\":\"string\"},{\"name\":\"Peso\",\"type\":\"string\"},{\"name\":\"Volumen\",\"type\":\"string\"},{\"name\":\"ValorDeclarado\",\"type\":\"string\"},{\"name\":\"AltoCm\",\"type\":\"string\"},{\"name\":\"AnchoCm\",\"type\":\"string\"},{\"name\":\"LargoCm\",\"type\":\"string\"},{\"name\":\"TipoDeEnvioId\",\"type\":\"string\"},{\"name\":\"ItemId\",\"type\":\"string\"},{\"name\":\"PesoUnidad\",\"type\":\"string\"}],\"name\":\"Andreani.CorpoCotizar.Events.Common.Envio\",\"type\":\"record\"}"
}

func (r Envio) SchemaName() string {
	return "Andreani.CorpoCotizar.Events.Common.Envio"
}
