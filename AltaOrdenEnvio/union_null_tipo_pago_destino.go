...
func (r *UnionNullTipoPagoDestino) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullTipoPagoDestinoTypeEnumTipoPagoDestino:
		return json.Marshal(map[string]interface{}{"Andreani.AltaOrdenEnvio.Events.Common.TipoPagoDestino": r.TipoPagoDestino})
	}
...
func (r *UnionNullTipoPagoDestino) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.AltaOrdenEnvio.Events.Common.TipoPagoDestino"]; ok {
		r.UnionType = 1
