...
type ActualizacionEnvioSolicitada struct {
	...
	BultoRequest *UnionNullDetalleDePaquete `json:"BultoRequest"`
...
const ActualizacionEnvioSolicitadaAvroCRC64Fingerprint = "\xa7a\xf3s\xc0\x92\xb8\xc6"
...
func writeActualizacionEnvioSolicitada(r ActualizacionEnvioSolicitada, w io.Writer) error {
	...
	err = writeUnionNullDetalleDePaquete(r.BultoRequest, w)
	if err != nil {
		return err
	}
...
func (r *ActualizacionEnvioSolicitada) Get(i int) types.Field {
	...
	case 2:
		...
		return r.Contrato
	case 3:
		r.BultoRequest = NewUnionNullDetalleDePaquete()
