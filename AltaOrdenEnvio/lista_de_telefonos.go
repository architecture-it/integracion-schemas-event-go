...
const ListaDeTelefonosAvroCRC64Fingerprint = "t\xc2\x1ezr\x01\xd3\xf2"
...
func (r ListaDeTelefonos) Schema() string {
	return "{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"tipo\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Andreani.AltaOrdenEnvio.Events.Common.ListaDeTelefonos\",\"type\":\"record\"}"
}

func (r ListaDeTelefonos) SchemaName() string {
	return "Andreani.AltaOrdenEnvio.Events.Common.ListaDeTelefonos"
}
