...
func (r *UnionNullDatosSucursal) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"codigo\",\"type\":\"string\"},{\"default\":null,\"name\":\"nombre\",\"type\":[\"null\",\"string\"]},{\"name\":\"id\",\"type\":\"string\"}],\"name\":\"DatosSucursal\",\"type\":\"record\"}]"
}
...
func (r *UnionNullDatosSucursal) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDatosSucursalTypeEnumDatosSucursal:
		return json.Marshal(map[string]interface{}{"Andreani.AltaOrdenEnvio.Events.Common.DatosSucursal": r.DatosSucursal})
	}
...
func (r *UnionNullDatosSucursal) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.AltaOrdenEnvio.Events.Common.DatosSucursal"]; ok {
		r.UnionType = 1
