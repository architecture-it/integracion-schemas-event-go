...
type DetalleDeOrdenDeEnvio struct {
	...
	PagoEnMostrador *UnionNullTipoPagoDestino `json:"pagoEnMostrador"`
}

const DetalleDeOrdenDeEnvioAvroCRC64Fingerprint = "։j\xd7Dq\xd3\xe1"
...
func writeDetalleDeOrdenDeEnvio(r DetalleDeOrdenDeEnvio, w io.Writer) error {
	...
	err = writeUnionNullTipoPagoDestino(r.PagoEnMostrador, w)
	if err != nil {
		return err
	}
	return err
...
func (r *DetalleDeOrdenDeEnvio) Get(i int) types.Field {
	...
	case 24:
		...
		return r.IdPedido
	case 25:
		r.PagoEnMostrador = NewUnionNullTipoPagoDestino()
