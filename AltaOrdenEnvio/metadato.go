...
const MetadatoAvroCRC64Fingerprint = "ˀu\xb5lC.a"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"meta\",\"type\":\"string\"},{\"name\":\"contenido\",\"type\":\"string\"}],\"name\":\"Andreani.AltaOrdenEnvio.Events.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.AltaOrdenEnvio.Events.Common.Metadato"
}
