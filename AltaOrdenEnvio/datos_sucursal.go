...
const DatosSucursalAvroCRC64Fingerprint = "\x15\xd80\f\x83g\xaf\x85"
...
func (r DatosSucursal) Schema() string {
	return "{\"fields\":[{\"name\":\"codigo\",\"type\":\"string\"},{\"default\":null,\"name\":\"nombre\",\"type\":[\"null\",\"string\"]},{\"name\":\"id\",\"type\":\"string\"}],\"name\":\"Andreani.AltaOrdenEnvio.Events.Common.DatosSucursal\",\"type\":\"record\"}"
}

func (r DatosSucursal) SchemaName() string {
	return "Andreani.AltaOrdenEnvio.Events.Common.DatosSucursal"
}
