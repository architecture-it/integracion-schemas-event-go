...
func (r *UnionNullListaDePropiedades) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDePropiedadesTypeEnumListaDePropiedades:
		return json.Marshal(map[string]interface{}{"Andreani.AltaOrdenEnvio.Events.Common.ListaDePropiedades": r.ListaDePropiedades})
	}
...
func (r *UnionNullListaDePropiedades) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.AltaOrdenEnvio.Events.Common.ListaDePropiedades"]; ok {
		r.UnionType = 1
