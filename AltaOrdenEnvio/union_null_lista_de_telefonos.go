...
func (r *UnionNullListaDeTelefonos) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"tipo\",\"type\":\"string\"},{\"name\":\"numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"ListaDeTelefonos\",\"type\":\"record\"}]"
}
...
func (r *UnionNullListaDeTelefonos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeTelefonosTypeEnumListaDeTelefonos:
		return json.Marshal(map[string]interface{}{"Andreani.AltaOrdenEnvio.Events.Common.ListaDeTelefonos": r.ListaDeTelefonos})
	}
...
func (r *UnionNullListaDeTelefonos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.AltaOrdenEnvio.Events.Common.ListaDeTelefonos"]; ok {
		r.UnionType = 1
