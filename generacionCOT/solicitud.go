...
type Solicitud struct {
	...
	DestinatarioPiso string `json:"DestinatarioPiso"`

	DestinatarioDepartamento string `json:"DestinatarioDepartamento"`
	...
	OrigenPiso string `json:"OrigenPiso"`

	OrigenDepartamento string `json:"OrigenDepartamento"`
...
const SolicitudAvroCRC64Fingerprint = "*2\xf2\xa0\xc1\xc9ţ"
...
func writeSolicitud(r Solicitud, w io.Writer) error {
	...
	err = vm.WriteString(r.DestinatarioPiso, w)
	if err != nil {
		return err
	}
	err = vm.WriteString(r.DestinatarioDepartamento, w)
	if err != nil {
		return err
	}
	...
	err = vm.WriteString(r.OrigenPiso, w)
	if err != nil {
		return err
	}
	err = vm.WriteString(r.OrigenDepartamento, w)
	if err != nil {
		return err
	}
...
func (r Solicitud) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"IdPropietario\",\"type\":\"int\"},{\"name\":\"Numero\",\"type\":\"string\"},{\"name\":\"CodComprobante\",\"type\":\"string\"},{\"name\":\"CentroEmisorComprobante\",\"type\":\"int\"},{\"name\":\"NumeroComprobante\",\"type\":\"int\"},{\"name\":\"ImporteComprobante\",\"type\":{\"logicalType\":\"decimal\",\"precision\":12,\"scale\":2,\"type\":\"bytes\"}},{\"name\":\"DestinatarioCUIT\",\"type\":\"string\"},{\"name\":\"DestinatarioRazonSocial\",\"type\":\"string\"},{\"name\":\"DestinatarioCalle\",\"type\":\"string\"},{\"name\":\"DestinatarioNumero\",\"type\":\"string\"},{\"name\":\"DestinatarioPiso\",\"type\":\"string\"},{\"name\":\"DestinatarioDepartamento\",\"type\":\"string\"},{\"name\":\"DestinatarioCodigoPostal\",\"type\":\"string\"},{\"name\":\"DestinatarioLocalidad\",\"type\":\"string\"},{\"name\":\"DestinatarioProvincia\",\"type\":\"string\"},{\"name\":\"OrigenCUIT\",\"type\":\"string\"},{\"name\":\"OrigenRazonSocial\",\"type\":\"string\"},{\"name\":\"OrigenCalle\",\"type\":\"string\"},{\"name\":\"OrigenNumero\",\"type\":\"string\"},{\"name\":\"OrigenPiso\",\"type\":\"string\"},{\"name\":\"OrigenDepartamento\",\"type\":\"string\"},{\"name\":\"OrigenCodigoPostal\",\"type\":\"string\"},{\"name\":\"OrigenLocalidad\",\"type\":\"string\"},{\"name\":\"OrigenProvincia\",\"type\":\"string\"},{\"name\":\"IdTransportista\",\"type\":\"int\"},{\"name\":\"Detalle\",\"type\":{\"items\":{\"fields\":[{\"name\":\"NumeroDeLinea\",\"type\":\"int\"},{\"name\":\"CodigoDeProducto\",\"type\":\"string\"},{\"name\":\"DescripcionDeProducto\",\"type\":\"string\"},{\"name\":\"CodigoUOM\",\"type\":\"string\"},{\"name\":\"DescripcionUO\",\"type\":\"string\"},{\"name\":\"Cantidad\",\"type\":\"int\"}],\"name\":\"Linea\",\"type\":\"record\"},\"type\":\"array\"}}],\"name\":\"Andreani.GeneracionCot.Events.Record.Solicitud\",\"type\":\"record\"}"
}
...
func (r *Solicitud) Get(i int) types.Field {
	...
	case 11:
		w := types.String{Target: &r.DestinatarioPiso}

		return w

	case 12:
		w := types.String{Target: &r.DestinatarioDepartamento}
	...
	case 20:
		w := types.String{Target: &r.OrigenPiso}

		return w

	case 21:
		w := types.String{Target: &r.OrigenDepartamento}
