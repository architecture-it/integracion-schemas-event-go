...
const EventoDeNegocioAvroCRC64Fingerprint = "\x18\xa2ç\xae\xfc\xc4\x13"
...
func (r EventoDeNegocio) Schema() string {
	return "{\"fields\":[{\"name\":\"Timestamp\",\"type\":\"int\"},{\"name\":\"Remitente\",\"type\":\"string\"},{\"default\":null,\"name\":\"Destinatario\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"NumeroDeOrden\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Vencimiento\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.WapTrasladoInternoDeMercaderiaV2.Events.Record.EventoDeNegocio\",\"type\":\"record\"}"
}

func (r EventoDeNegocio) SchemaName() string {
	return "Andreani.WapTrasladoInternoDeMercaderiaV2.Events.Record.EventoDeNegocio"
}
