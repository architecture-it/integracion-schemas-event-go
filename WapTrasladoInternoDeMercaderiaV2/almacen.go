...
const AlmacenAvroCRC64Fingerprint = "\xbf\xeb\x9f2\x19\xcfH8"
...
func (r Almacen) Schema() string {
	return "{\"fields\":[{\"name\":\"Destino\",\"type\":\"string\"},{\"name\":\"Origen\",\"type\":\"string\"}],\"name\":\"Andreani.WapTrasladoInternoDeMercaderiaV2.Events.Record.Almacen\",\"type\":\"record\"}"
}

func (r Almacen) SchemaName() string {
	return "Andreani.WapTrasladoInternoDeMercaderiaV2.Events.Record.Almacen"
}
