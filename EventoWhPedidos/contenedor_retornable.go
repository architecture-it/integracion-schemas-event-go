...
const ContenedorRetornableAvroCRC64Fingerprint = "\xb7\xb5ڙ\x01\"O\x02"
...
func (r ContenedorRetornable) Schema() string {
	return "{\"fields\":[{\"name\":\"Tara\",\"type\":\"float\"},{\"name\":\"CartonType\",\"type\":\"string\"},{\"name\":\"ContratoRetornable\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.EventoWhPedidos.Events.BultosEmpaquetadoCommon.ContenedorRetornable\",\"type\":\"record\"}"
}

func (r ContenedorRetornable) SchemaName() string {
	return "Andreani.EventoWhPedidos.Events.BultosEmpaquetadoCommon.ContenedorRetornable"
}
