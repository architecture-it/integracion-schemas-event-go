...
/*
 * SOURCE:
 *     EventoWhPedidosCancelacion.avsc
 */
...
type EventoWhPedidosCancelacion struct {
...
const EventoWhPedidosCancelacionAvroCRC64Fingerprint = "E\xd9\xc2\f\x86Ǌ\xba"

func NewEventoWhPedidosCancelacion() EventoWhPedidosCancelacion {
	r := EventoWhPedidosCancelacion{}
...
func DeserializeEventoWhPedidosCancelacion(r io.Reader) (EventoWhPedidosCancelacion, error) {
	t := NewEventoWhPedidosCancelacion()
...
func DeserializeEventoWhPedidosCancelacionFromSchema(r io.Reader, schema string) (EventoWhPedidosCancelacion, error) {
	t := NewEventoWhPedidosCancelacion()
...
func writeEventoWhPedidosCancelacion(r EventoWhPedidosCancelacion, w io.Writer) error {
	var err error
...
func (r *EventoWhPedidosCancelacion) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhPedidosCancelacion) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhPedidosCancelacion) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhPedidosCancelacion) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhPedidosCancelacion) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhPedidosCancelacion) Finalize()                        {}

func (_ EventoWhPedidosCancelacion) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhPedidosCancelacionAvroCRC64Fingerprint)
}

func (r EventoWhPedidosCancelacion) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhPedidosCancelacion) UnmarshalJSON(data []byte) error {
