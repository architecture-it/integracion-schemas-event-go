...
type EventoWhPedidosPreasignados struct {
...
const EventoWhPedidosPreasignadosAvroCRC64Fingerprint = "\xaa\x04.1\xbd֖T"

func NewEventoWhPedidosPreasignados() EventoWhPedidosPreasignados {
	r := EventoWhPedidosPreasignados{}
...
func DeserializeEventoWhPedidosPreasignados(r io.Reader) (EventoWhPedidosPreasignados, error) {
	t := NewEventoWhPedidosPreasignados()
...
func DeserializeEventoWhPedidosPreasignadosFromSchema(r io.Reader, schema string) (EventoWhPedidosPreasignados, error) {
	t := NewEventoWhPedidosPreasignados()
...
func writeEventoWhPedidosPreasignados(r EventoWhPedidosPreasignados, w io.Writer) error {
	var err error
...
func (r *EventoWhPedidosPreasignados) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhPedidosPreasignados) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhPedidosPreasignados) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhPedidosPreasignados) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhPedidosPreasignados) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhPedidosPreasignados) Finalize()                {}

func (_ EventoWhPedidosPreasignados) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhPedidosPreasignadosAvroCRC64Fingerprint)
}

func (r EventoWhPedidosPreasignados) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhPedidosPreasignados) UnmarshalJSON(data []byte) error {
