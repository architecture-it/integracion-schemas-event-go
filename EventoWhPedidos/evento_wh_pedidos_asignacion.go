...
/*
 * SOURCE:
 *     EventoWhPedidosAsignacion.avsc
 */
...
type EventoWhPedidosAsignacion struct {
...
const EventoWhPedidosAsignacionAvroCRC64Fingerprint = "\xbf\xa5{\x9b\xfdV\x8f\x1c"

func NewEventoWhPedidosAsignacion() EventoWhPedidosAsignacion {
	r := EventoWhPedidosAsignacion{}
...
func DeserializeEventoWhPedidosAsignacion(r io.Reader) (EventoWhPedidosAsignacion, error) {
	t := NewEventoWhPedidosAsignacion()
...
func DeserializeEventoWhPedidosAsignacionFromSchema(r io.Reader, schema string) (EventoWhPedidosAsignacion, error) {
	t := NewEventoWhPedidosAsignacion()
...
func writeEventoWhPedidosAsignacion(r EventoWhPedidosAsignacion, w io.Writer) error {
	var err error
...
func (r *EventoWhPedidosAsignacion) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhPedidosAsignacion) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhPedidosAsignacion) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ EventoWhPedidosAsignacion) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ EventoWhPedidosAsignacion) HintSize(int)                     { panic("Unsupported operation") }
func (_ EventoWhPedidosAsignacion) Finalize()                        {}

func (_ EventoWhPedidosAsignacion) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhPedidosAsignacionAvroCRC64Fingerprint)
}

func (r EventoWhPedidosAsignacion) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhPedidosAsignacion) UnmarshalJSON(data []byte) error {
