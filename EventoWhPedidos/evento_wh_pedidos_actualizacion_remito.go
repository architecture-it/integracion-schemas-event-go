...
/*
 * SOURCE:
 *     EventoWhPedidosActualizacionRemito.avsc
 */
...
type EventoWhPedidosActualizacionRemito struct {
...
const EventoWhPedidosActualizacionRemitoAvroCRC64Fingerprint = "\n[`\xc2:U\xda\xfa"

func NewEventoWhPedidosActualizacionRemito() EventoWhPedidosActualizacionRemito {
	r := EventoWhPedidosActualizacionRemito{}
...
func DeserializeEventoWhPedidosActualizacionRemito(r io.Reader) (EventoWhPedidosActualizacionRemito, error) {
	t := NewEventoWhPedidosActualizacionRemito()
...
func DeserializeEventoWhPedidosActualizacionRemitoFromSchema(r io.Reader, schema string) (EventoWhPedidosActualizacionRemito, error) {
	t := NewEventoWhPedidosActualizacionRemito()
...
func writeEventoWhPedidosActualizacionRemito(r EventoWhPedidosActualizacionRemito, w io.Writer) error {
	var err error
...
func (r *EventoWhPedidosActualizacionRemito) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *EventoWhPedidosActualizacionRemito) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ EventoWhPedidosActualizacionRemito) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ EventoWhPedidosActualizacionRemito) AppendArray() types.Field { panic("Unsupported operation") }
func (_ EventoWhPedidosActualizacionRemito) HintSize(int)             { panic("Unsupported operation") }
func (_ EventoWhPedidosActualizacionRemito) Finalize()                {}

func (_ EventoWhPedidosActualizacionRemito) AvroCRC64Fingerprint() []byte {
	return []byte(EventoWhPedidosActualizacionRemitoAvroCRC64Fingerprint)
}

func (r EventoWhPedidosActualizacionRemito) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *EventoWhPedidosActualizacionRemito) UnmarshalJSON(data []byte) error {
