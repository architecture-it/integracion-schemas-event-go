...
const RepublicOrderAvroCRC64Fingerprint = "\xfbȣ\xc0\xb7\x000\x17"
...
func (r RepublicOrder) Schema() string {
	return "{\"fields\":[{\"name\":\"ids\",\"type\":{\"items\":\"string\",\"type\":\"array\"}},{\"name\":\"user\",\"type\":\"string\"}],\"name\":\"Andreani.RepublicOrder.Events.Record.RepublicOrder\",\"type\":\"record\"}"
}

func (r RepublicOrder) SchemaName() string {
	return "Andreani.RepublicOrder.Events.Record.RepublicOrder"
}
