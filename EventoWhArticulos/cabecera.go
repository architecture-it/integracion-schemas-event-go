...
func writeCabecera(r Cabecera, w io.Writer) error {
	...
	err = writeUnionNullString(r.MascaraSeries, w)
	if err != nil {
		return err
	}
	return err
...
func (r Cabecera) MarshalJSON() ([]byte, error) {
	...
	output["MascaraSeries"], err = json.Marshal(r.MascaraSeries)
	if err != nil {
		return nil, err
	}
...
func (r *Cabecera) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["MascaraSeries"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.MascaraSeries); err != nil {
			return err
		}
	} else {
		r.MascaraSeries = NewUnionNullString()
