...
const CharacteristicsAvroCRC64Fingerprint = "=bbtr5/\x7f"
...
func (r Characteristics) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"long\"},{\"name\":\"Value\",\"type\":\"string\"}],\"name\":\"Andreani.OperativeUnit.Events.Record.Characteristics\",\"type\":\"record\"}"
}
