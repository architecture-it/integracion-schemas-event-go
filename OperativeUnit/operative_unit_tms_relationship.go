...
const OperativeUnitTMSRelationshipAvroCRC64Fingerprint = "\xef\xbct\x133\x1a&\x10"
...
func (r OperativeUnitTMSRelationship) Schema() string {
	return "{\"fields\":[{\"name\":\"idIntegra\",\"type\":\"long\"},{\"name\":\"idAlertran\",\"type\":\"string\"},{\"name\":\"defaultTMS\",\"type\":\"string\"}],\"name\":\"Andreani.OperativeUnit.Events.Record.OperativeUnitTMSRelationship\",\"type\":\"record\"}"
}
