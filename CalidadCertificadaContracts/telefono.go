...
const TelefonoAvroCRC64Fingerprint = "s\x99D\x90\x8d\x90\x91\xcc"
...
func (r Telefono) Schema() string {
	return "{\"fields\":[{\"name\":\"Tipo\",\"type\":\"string\"},{\"name\":\"Numero\",\"type\":\"string\"}],\"name\":\"Andreani.CalidadCertificadaContracts.Events.Common.Telefono\",\"type\":\"record\"}"
}

func (r Telefono) SchemaName() string {
	return "Andreani.CalidadCertificadaContracts.Events.Common.Telefono"
}
