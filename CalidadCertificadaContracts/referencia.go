...
const ReferenciaAvroCRC64Fingerprint = "}w\xe6G\x9f\xa8\xa3\n"
...
func (r Referencia) Schema() string {
	return "{\"fields\":[{\"name\":\"Meta\",\"type\":\"string\"},{\"name\":\"Contenido\",\"type\":\"string\"}],\"name\":\"Andreani.CalidadCertificadaContracts.Events.Common.Referencia\",\"type\":\"record\"}"
}

func (r Referencia) SchemaName() string {
	return "Andreani.CalidadCertificadaContracts.Events.Common.Referencia"
}
