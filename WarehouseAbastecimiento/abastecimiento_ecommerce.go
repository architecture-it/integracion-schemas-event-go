...
type AbastecimientoEcommerce struct {
	...
	TipoUnidadEnvio *UnionNullString `json:"TipoUnidadEnvio"`

	TipoAbastecimiento *UnionNullString `json:"TipoAbastecimiento"`

	AbastecimientoId *UnionNullString `json:"AbastecimientoId"`
}

const AbastecimientoEcommerceAvroCRC64Fingerprint = "\x02\x88_\x0f\xdd\xd6\xf8j"
...
func NewAbastecimientoEcommerce() AbastecimientoEcommerce {
	...
	r.NroOperacion = nil
	r.TipoUnidadEnvio = nil
	r.TipoAbastecimiento = nil
...
func writeAbastecimientoEcommerce(r AbastecimientoEcommerce, w io.Writer) error {
	...
	err = writeUnionNullString(r.TipoUnidadEnvio, w)
	if err != nil {
		return err
	}
	err = writeUnionNullString(r.TipoAbastecimiento, w)
	if err != nil {
		return err
	}
...
func (r *AbastecimientoEcommerce) Get(i int) types.Field {
	...
	case 12:
		r.TipoUnidadEnvio = NewUnionNullString()

		return r.TipoUnidadEnvio
	case 13:
		r.TipoAbastecimiento = NewUnionNullString()

		return r.TipoAbastecimiento
	case 14:
...
func (r AbastecimientoEcommerce) MarshalJSON() ([]byte, error) {
	...
	output["TipoUnidadEnvio"], err = json.Marshal(r.TipoUnidadEnvio)
	if err != nil {
		return nil, err
	}
	output["TipoAbastecimiento"], err = json.Marshal(r.TipoAbastecimiento)
	if err != nil {
		return nil, err
	}
...
func (r *AbastecimientoEcommerce) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["TipoUnidadEnvio"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.TipoUnidadEnvio); err != nil {
			return err
		}
	} else {
		r.TipoUnidadEnvio = NewUnionNullString()
	...
	val = func() json.RawMessage {
		if v, ok := fields["TipoAbastecimiento"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.TipoAbastecimiento); err != nil {
			return err
		}
	} else {
		r.TipoAbastecimiento = NewUnionNullString()
