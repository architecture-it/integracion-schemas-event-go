...
const ConfirmacionEnvioAvroCRC64Fingerprint = "\vf\x9e\x02\xd2\b\xfb\x90"
...
func (r ConfirmacionEnvio) Schema() string {
	return "{\"fields\":[{\"name\":\"Codigo\",\"type\":\"string\"},{\"default\":null,\"name\":\"Mensaje\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.FacturacionCliente.Events.Record.ConfirmacionEnvio\",\"type\":\"record\"}"
}

func (r ConfirmacionEnvio) SchemaName() string {
	return "Andreani.FacturacionCliente.Events.Record.ConfirmacionEnvio"
}
