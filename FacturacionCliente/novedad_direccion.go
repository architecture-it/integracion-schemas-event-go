...
const NovedadDireccionAvroCRC64Fingerprint = "\x03Fݚ\xcbJ\xb4+"
...
func (r NovedadDireccion) Schema() string {
	return "{\"fields\":[{\"name\":\"CodigoDeDireccion\",\"type\":\"string\"},{\"name\":\"Fecha\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}},{\"name\":\"DomicilioReal\",\"type\":{\"fields\":[{\"name\":\"AbreviaturaProvincia\",\"type\":\"string\"},{\"name\":\"Calle\",\"type\":\"string\"},{\"name\":\"CodigoCiudad\",\"type\":\"string\"},{\"name\":\"CodigoPostal\",\"type\":\"int\"},{\"name\":\"NombreProvincia\",\"type\":\"string\"},{\"name\":\"Numero\",\"type\":\"int\"}],\"name\":\"DatosDomicilio\",\"namespace\":\"Andreani.FacturacionCliente.Events.Common\",\"type\":\"record\"}}],\"name\":\"Andreani.FacturacionCliente.Events.Record.NovedadDireccion\",\"type\":\"record\"}"
}

func (r NovedadDireccion) SchemaName() string {
	return "Andreani.FacturacionCliente.Events.Record.NovedadDireccion"
}
