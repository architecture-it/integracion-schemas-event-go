...
type NovedadAnalizada struct {
	...
	IdTrazaConfiguracion int32 `json:"idTrazaConfiguracion"`
...
const NovedadAnalizadaAvroCRC64Fingerprint = "\xec\x1cN\x9d\xfa\x87\xfc\xcd"
...
func writeNovedadAnalizada(r NovedadAnalizada, w io.Writer) error {
	...
	err = vm.WriteInt(r.IdTrazaConfiguracion, w)
	if err != nil {
		return err
	}
...
func (r *NovedadAnalizada) Get(i int) types.Field {
	...
	case 6:
		w := types.Int{Target: &r.IdTrazaConfiguracion}
...
func (r NovedadAnalizada) MarshalJSON() ([]byte, error) {
	...
	output["idTrazaConfiguracion"], err = json.Marshal(r.IdTrazaConfiguracion)
	if err != nil {
		return nil, err
	}
...
func (r *NovedadAnalizada) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["idTrazaConfiguracion"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.IdTrazaConfiguracion); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for idTrazaConfiguracion")
	}
	val = func() json.RawMessage {
