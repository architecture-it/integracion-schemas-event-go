...
func (r *UnionNullListaDePropiedades) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDePropiedadesTypeEnumListaDePropiedades:
		return json.Marshal(map[string]interface{}{"Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDePropiedades": r.ListaDePropiedades})
	}
...
func (r *UnionNullListaDePropiedades) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDePropiedades"]; ok {
		r.UnionType = 1
