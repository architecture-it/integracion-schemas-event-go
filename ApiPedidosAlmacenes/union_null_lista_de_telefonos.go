...
func (r *UnionNullListaDeTelefonos) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"Tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"Numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"ListaDeTelefonos\",\"type\":\"record\"}]"
}
...
func (r *UnionNullListaDeTelefonos) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullListaDeTelefonosTypeEnumListaDeTelefonos:
		return json.Marshal(map[string]interface{}{"Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDeTelefonos": r.ListaDeTelefonos})
	}
...
func (r *UnionNullListaDeTelefonos) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDeTelefonos"]; ok {
		r.UnionType = 1
