...
const MetadatoAvroCRC64Fingerprint = "~rl7\x1dˉ\xeb"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"Meta\",\"type\":\"string\"},{\"name\":\"Contenido\",\"type\":\"string\"}],\"name\":\"Andreani.WapAltaDePedidoSolicitada.Events.Record.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.WapAltaDePedidoSolicitada.Events.Record.Metadato"
}
