...
const SolicitudDeAccionAlmacenAvroCRC64Fingerprint = "%O\v\x969\xa6\xdbv"
...
func (r SolicitudDeAccionAlmacen) Schema() string {
	return "{\"fields\":[{\"name\":\"EventoDeNegocio\",\"type\":{\"fields\":[{\"name\":\"Timestamp\",\"type\":\"int\"},{\"name\":\"Remitente\",\"type\":\"string\"},{\"name\":\"Destinatario\",\"type\":[\"null\",\"string\"]},{\"name\":\"NumeroDeOrden\",\"type\":[\"null\",\"string\"]},{\"name\":\"Vencimiento\",\"type\":[\"null\",\"string\"]}],\"name\":\"EventoDeNegocio\",\"type\":\"record\"}},{\"name\":\"IdTransaccion\",\"type\":\"string\"},{\"name\":\"Contrato\",\"type\":\"string\"},{\"name\":\"Almacen\",\"type\":\"string\"},{\"name\":\"Planta\",\"type\":\"string\"}],\"name\":\"Andreani.WapAltaDePedidoSolicitada.Events.Record.SolicitudDeAccionAlmacen\",\"type\":\"record\"}"
}

func (r SolicitudDeAccionAlmacen) SchemaName() string {
	return "Andreani.WapAltaDePedidoSolicitada.Events.Record.SolicitudDeAccionAlmacen"
}
