...
const ListaDeTelefonosAvroCRC64Fingerprint = "ܬ\x00\x9eT/@J"
...
func (r ListaDeTelefonos) Schema() string {
	return "{\"fields\":[{\"name\":\"listaDeTelefonos\",\"type\":[\"null\",{\"items\":{\"fields\":[{\"name\":\"Tipo\",\"type\":[\"null\",\"string\"]},{\"name\":\"Numero\",\"type\":\"string\"}],\"name\":\"Telefono\",\"type\":\"record\"},\"type\":\"array\"}]}],\"name\":\"Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDeTelefonos\",\"type\":\"record\"}"
}

func (r ListaDeTelefonos) SchemaName() string {
	return "Andreani.WapAltaDePedidoSolicitada.Events.Record.ListaDeTelefonos"
}
