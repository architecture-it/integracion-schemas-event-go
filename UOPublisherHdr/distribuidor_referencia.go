...
const DistribuidorReferenciaAvroCRC64Fingerprint = "\xd4\x14\x03D\x18\x8ej\x9d"
...
func (r DistribuidorReferencia) Schema() string {
	return "{\"fields\":[{\"name\":\"Origen\",\"type\":\"string\"},{\"name\":\"Sucursal\",\"type\":\"string\"},{\"name\":\"Tipo\",\"type\":\"string\"},{\"name\":\"Codigo\",\"type\":\"string\"}],\"name\":\"Andreani.UOPublisherHdr.Events.Common.DistribuidorReferencia\",\"type\":\"record\"}"
}

func (r DistribuidorReferencia) SchemaName() string {
	return "Andreani.UOPublisherHdr.Events.Common.DistribuidorReferencia"
}
