...
const SucursalReferenciaAvroCRC64Fingerprint = "\x8fɿ\xde1(!\xeb"
...
func (r SucursalReferencia) Schema() string {
	return "{\"fields\":[{\"name\":\"UnificacionId\",\"type\":\"string\"},{\"name\":\"SucursalId\",\"type\":\"string\"},{\"name\":\"Origen\",\"type\":\"string\"}],\"name\":\"Andreani.UOPublisherHdr.Events.Common.SucursalReferencia\",\"type\":\"record\"}"
}

func (r SucursalReferencia) SchemaName() string {
	return "Andreani.UOPublisherHdr.Events.Common.SucursalReferencia"
}
