...
const CondicionesDeEntregaAvroCRC64Fingerprint = "\xf7=\x88$\x03H\xe9\xd0"
...
func (r CondicionesDeEntrega) Schema() string {
	return "{\"fields\":[{\"name\":\"CondicionDeEntregaId\",\"type\":\"string\"},{\"name\":\"Descripcion\",\"type\":\"string\"}],\"name\":\"Andreani.DMS.Events.Hdr.Common.CondicionesDeEntrega\",\"type\":\"record\"}"
}

func (r CondicionesDeEntrega) SchemaName() string {
	return "Andreani.DMS.Events.Hdr.Common.CondicionesDeEntrega"
}
