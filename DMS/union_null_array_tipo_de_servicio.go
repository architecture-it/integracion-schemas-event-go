...
func (r *UnionNullArrayTipoDeServicio) Schema() string {
	return "[\"null\",{\"items\":{\"fields\":[{\"name\":\"TipoDeServicioId\",\"type\":\"int\"},{\"name\":\"Nombre\",\"type\":\"string\"}],\"name\":\"TipoDeServicio\",\"namespace\":\"Andreani.DMS.Events.Hdr.Common\",\"type\":\"record\"},\"type\":\"array\"}]"
}
