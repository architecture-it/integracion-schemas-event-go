...
const MetadatoAvroCRC64Fingerprint = "\xe9p\xc8\xc33\xbb\x04\xe1"
...
func (r Metadato) Schema() string {
	return "{\"fields\":[{\"name\":\"Meta\",\"type\":\"string\"},{\"name\":\"Contenido\",\"type\":\"string\"}],\"name\":\"Andreani.DMS.Events.Hdr.Common.Metadato\",\"type\":\"record\"}"
}

func (r Metadato) SchemaName() string {
	return "Andreani.DMS.Events.Hdr.Common.Metadato"
}
