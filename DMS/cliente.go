...
const ClienteAvroCRC64Fingerprint = "\x8a\x17څ\xbb\xa2\xe9g"
...
func (r Cliente) Schema() string {
	return "{\"fields\":[{\"name\":\"ClienteId\",\"type\":\"int\"},{\"name\":\"Codigo\",\"type\":\"string\"},{\"default\":null,\"name\":\"IdentificadorCliente\",\"type\":[\"null\",\"string\"]},{\"name\":\"Nombre\",\"type\":\"string\"}],\"name\":\"Andreani.DMS.Events.Hdr.Common.Cliente\",\"type\":\"record\"}"
}

func (r Cliente) SchemaName() string {
	return "Andreani.DMS.Events.Hdr.Common.Cliente"
}
