...
const GeoPosAvroCRC64Fingerprint = "\xde^\xe7Vv\xfeM\xf1"
...
func (r GeoPos) Schema() string {
	return "{\"fields\":[{\"name\":\"Latitud\",\"type\":\"string\"},{\"name\":\"Longitud\",\"type\":\"string\"}],\"name\":\"Andreani.DMS.Events.Hdr.Common.GeoPos\",\"type\":\"record\"}"
}

func (r GeoPos) SchemaName() string {
	return "Andreani.DMS.Events.Hdr.Common.GeoPos"
}
