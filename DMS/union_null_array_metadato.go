...
func (r *UnionNullArrayMetadato) Schema() string {
	return "[\"null\",{\"items\":{\"fields\":[{\"name\":\"Meta\",\"type\":\"string\"},{\"name\":\"Contenido\",\"type\":\"string\"}],\"name\":\"Metadato\",\"namespace\":\"Andreani.DMS.Events.Hdr.Common\",\"type\":\"record\"},\"type\":\"array\"}]"
}
