...
const StructureReasonAvroCRC64Fingerprint = "\xb7RS7\a\x84\xfa\xfd"
...
func (r StructureReason) Schema() string {
	return "{\"fields\":[{\"name\":\"Id\",\"type\":\"int\"},{\"name\":\"Description\",\"type\":\"string\"},{\"name\":\"Reason\",\"type\":\"string\"}],\"name\":\"Andreani.RHpro.Events.Common.StructureReason\",\"type\":\"record\"}"
}

func (r StructureReason) SchemaName() string {
	return "Andreani.RHpro.Events.Common.StructureReason"
}
