...
/*
 * SOURCE:
 *     OperacionesTareaNotificacionEnvioNotificadoV2.avsc
 */
...
type OperacionesTareaNotificacionEnvioNotificadoV2 struct {
...
func DeserializeOperacionesTareaNotificacionEnvioNotificadoV2(r io.Reader) (OperacionesTareaNotificacionEnvioNotificadoV2, error) {
	t := NewOperacionesTareaNotificacionEnvioNotificadoV2()
...
func DeserializeOperacionesTareaNotificacionEnvioNotificadoV2FromSchema(r io.Reader, schema string) (OperacionesTareaNotificacionEnvioNotificadoV2, error) {
	t := NewOperacionesTareaNotificacionEnvioNotificadoV2()
...
func writeOperacionesTareaNotificacionEnvioNotificadoV2(r OperacionesTareaNotificacionEnvioNotificadoV2, w io.Writer) error {
	var err error
...
func (r OperacionesTareaNotificacionEnvioNotificadoV2) Serialize(w io.Writer) error {
	return writeOperacionesTareaNotificacionEnvioNotificadoV2(r, w)
}
...
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetInt(v int32) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetLong(v int64) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetFloat(v float32) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetDouble(v float64) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetBytes(v []byte) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetString(v string) {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) SetUnionElem(v int64) {
	panic("Unsupported operation")
}

func (r *OperacionesTareaNotificacionEnvioNotificadoV2) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *OperacionesTareaNotificacionEnvioNotificadoV2) SetDefault(i int) {
	switch i {
	case 0:
		r.Id = nil
		return
...
func (r *OperacionesTareaNotificacionEnvioNotificadoV2) NullField(i int) {
	switch i {
	case 0:
		r.Id = nil
		return
...
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) AppendMap(key string) types.Field {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) AppendArray() types.Field {
	panic("Unsupported operation")
}
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) HintSize(int) { panic("Unsupported operation") }
func (_ OperacionesTareaNotificacionEnvioNotificadoV2) Finalize()    {}

func (_ OperacionesTareaNotificacionEnvioNotificadoV2) AvroCRC64Fingerprint() []byte {
	return []byte(OperacionesTareaNotificacionEnvioNotificadoV2AvroCRC64Fingerprint)
}

func (r OperacionesTareaNotificacionEnvioNotificadoV2) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *OperacionesTareaNotificacionEnvioNotificadoV2) UnmarshalJSON(data []byte) error {
