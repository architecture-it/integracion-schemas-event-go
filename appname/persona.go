...
const PersonaAvroCRC64Fingerprint = "\xb2\x86\xb4\x94Rp\xb8("
...
func (r Persona) Schema() string {
	return "{\"fields\":[{\"name\":\"nombre\",\"type\":\"string\"},{\"name\":\"apellido\",\"type\":\"string\"}],\"name\":\"Andreani.pruebaPublicadorCFO.Events.Record.Persona\",\"type\":\"record\"}"
}
