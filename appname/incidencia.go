...
type Incidencia struct {
	...
	SerieArticulo *UnionNullString `json:"SerieArticulo"`
}

const IncidenciaAvroCRC64Fingerprint = "\x1e_<\xe2\x8c\x18\xca\xc6"
...
func writeIncidencia(r Incidencia, w io.Writer) error {
	...
	err = writeUnionNullString(r.SerieArticulo, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Incidencia) Get(i int) types.Field {
	...
	case 12:
		r.SerieArticulo = NewUnionNullString()

		return r.SerieArticulo
	}
...
func (r Incidencia) MarshalJSON() ([]byte, error) {
	...
	output["SerieArticulo"], err = json.Marshal(r.SerieArticulo)
	if err != nil {
		return nil, err
	}
...
func (r *Incidencia) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["SerieArticulo"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.SerieArticulo); err != nil {
			return err
		}
	} else {
		r.SerieArticulo = NewUnionNullString()
