...
const AcondicionamientoAvroCRC64Fingerprint = "\x96DN\xd3=\x88x5"
...
func (r Acondicionamiento) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"CodigoDeAconding\",\"type\":[\"null\",\"string\"]}],\"name\":\"Andreani.WapAjusteTrasladoInternoDeMercaderiaV2.Events.Record.Acondicionamiento\",\"type\":\"record\"}"
}

func (r Acondicionamiento) SchemaName() string {
	return "Andreani.WapAjusteTrasladoInternoDeMercaderiaV2.Events.Record.Acondicionamiento"
}
