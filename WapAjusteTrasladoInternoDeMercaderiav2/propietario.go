...
const PropietarioAvroCRC64Fingerprint = "\x92e\xa5\xd2\xff\xe01\xb7"
...
func (r Propietario) Schema() string {
	return "{\"fields\":[{\"name\":\"Destino\",\"type\":\"string\"},{\"name\":\"Origen\",\"type\":\"string\"}],\"name\":\"Andreani.WapAjusteTrasladoInternoDeMercaderiaV2.Events.Record.Propietario\",\"type\":\"record\"}"
}

func (r Propietario) SchemaName() string {
	return "Andreani.WapAjusteTrasladoInternoDeMercaderiaV2.Events.Record.Propietario"
}
